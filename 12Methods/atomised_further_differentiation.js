...
// 62 PTs (includes Exponential Growth and Decay), 602 questions (E:149 M:231 H:222)
  ...
  questions: [
    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 2*x + 6. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -6, "max": 4, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 6 or c2 != -1"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
              q: {},
              a: {},
            },
            sourceValues: {"c0": 1, "c1": 6, "c2": -1},
          }
        },
            {
              qid: "FD_001_e02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 6*x - 12. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -17, "max": -7, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 3 or c1 != -12 or c2 != 5"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 8 - 4*x. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": 3, "max": 13, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != -2 or c1 != 8 or c2 != 1"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 - 6*x. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -8, "max": 2, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -3 or c2 != 0"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": -3, "c2": 0, "c3": 1},
          }
        },
            {
              qid: "FD_001_m02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 8 - 2*x. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -6, "max": 4, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": 3, "max": 13, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -8, "max": 2, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != -1 or c1 != 8 or c2 != -3"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 4"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 6*x**2 - 18*x + 12. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -14, "max": -4, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": 7, "max": 17, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 2 or c1 != -9 or c2 != 12"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 2, "c1": -9, "c2": 12, "c3": -4},
          }
        },
            {
              qid: "FD_001_h02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 - 2. At x=1: gradient=1.0, y=-1.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": -2, "max": 4, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != -2"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
              grad_at_x: {"expr": "float(deriv.subs(x, x_val))", "note": "Gradient at x_val"},
              y_at_x: {"expr": "float(expr.subs(x, x_val))", "note": "y-value at x_val"},
            },
            substitutions: {
              q: {},
              a: {},
            },
            sourceValues: {"c0": 1, "c1": 0, "c2": -2, "c3": 0, "x_val": 1},
          }
        },
            {
              qid: "FD_001_h03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 + 2*x - 5. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -10, "max": 0, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 1 or c2 != -5"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": 1, "c2": -5, "c3": 3},
          }
        },
            {
              qid: "FD_001_h04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 4 or v2 != 2 or v3 != -4"],
            derived: {
            },
            substitutions: {
              q: {"4": "str(v1)", "2": "str(v2)", "-4": "str(v3)"},
              a: {"4": "str(v1)", "2": "str(v2)", "-4": "str(v3)"},
            },
            sourceValues: {"v1": 4, "v2": 2, "v3": -4},
          }
        },
            {
              qid: "FD_001_h05",
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"2": "str(v1)", "3": "str(v2)", "4": "str(v3)", "8": "str(v4)"},
              a: {"2": "str(v1)", "3": "str(v2)", "4": "str(v3)", "8": "str(v4)"},
            },
            sourceValues: {"v1": 2, "v2": 3, "v3": 4, "v4": 8},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "[Auto-fallback: maximum recursion depth exceeded] Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 1 (source: 2)"},
              v2: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 2 (source: 3)"},
            },
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v2: {"type": "int", "min": -14, "max": -4, "step": 1, "description": "Value 2 (source: -9)"},
              v3: {"type": "int", "min": -13, "max": -3, "step": 1, "description": "Value 3 (source: -8)"},
            },
            constraints: ["v1 != -3 or v2 != -9 or v3 != -8"],
            derived: {
            },
            substitutions: {
              q: {"-3": "str(v1)", "-9": "str(v2)", "-8": "str(v3)"},
              a: {"-3": "str(v1)", "-9": "str(v2)", "-8": "str(v3)"},
            },
            sourceValues: {"v1": -3, "v2": -9, "v3": -8},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 2*x - 3. At x=2: gradient=1.0, y=-1.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -8, "max": 2, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": -1, "max": 5, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != 1 or c1 != -3 or c2 != 1"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
              grad_at_x: {"expr": "float(deriv.subs(x, x_val))", "note": "Gradient at x_val"},
              y_at_x: {"expr": "float(expr.subs(x, x_val))", "note": "y-value at x_val"},
            ...
            sourceValues: {"c0": 1, "c1": -3, "c2": 1, "x_val": 2},
          }
        },
            {
              qid: "FD_002_e02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 6*x + 2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 3 or c1 != 2 or c2 != 0"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 6*x**2 + 2*x - 4. At x=-1: gradient=0.0, y=6.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": -4, "max": 2, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != 2 or c1 != 1 or c2 != -4"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
              grad_at_x: {"expr": "float(deriv.subs(x, x_val))", "note": "Gradient at x_val"},
              y_at_x: {"expr": "float(expr.subs(x, x_val))", "note": "y-value at x_val"},
            ...
            sourceValues: {"c0": 2, "c1": 1, "c2": -4, "c3": 3, "x_val": -1},
          }
        },
            {
              qid: "FD_002_m03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 0. At x=9: gradient=0.0, y=3.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": 6, "max": 12, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != 3 or x_val != 9"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
              grad_at_x: {"expr": "float(deriv.subs(x, x_val))", "note": "Gradient at x_val"},
              y_at_x: {"expr": "float(expr.subs(x, x_val))", "note": "y-value at x_val"},
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 - 8*x. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -4 or c2 != 0"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": -4, "c2": 0, "c3": 5},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 2*x - 2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -2 or c2 != 3"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 2*x. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != 0"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 - 1. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -6, "max": 4, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != -1"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -1, "c3": 0},
          }
        },
            {
              qid: "FD_002_h05",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 2*x + 4. At x=1: gradient=6.0, y=5.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": -2, "max": 4, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != 1 or c1 != 4 or c2 != 0"],
            ...
            sourceValues: {"c0": 1, "c1": 4, "c2": 0, "x_val": 1},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Coefficient of x^1"},
              c1: {"type": "int", "min": -6, "max": 4, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 2 or c1 != -1"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
...
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 12*x**3 - 4*x + 5. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 3 or c1 != 0 or c2 != -2"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 3, "c1": 0, "c2": -2, "c3": 5, "c4": 0},
          }
        },
            {
              qid: "FD_003_e02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 6*x**2 + 2*x - 7. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -12, "max": -2, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 2 or c1 != 1 or c2 != -7"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 2, "c1": 1, "c2": -7, "c3": 0},
          }
        },
            {
              qid: "FD_003_e03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 5*x**4 - 12*x**2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^5"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^4"},
              c2: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^3"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c4: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c5: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != -4"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -4, "c3": 0, "c4": 0, "c5": 0},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 5 or v2 != 3 or v3 != 2"],
            derived: {
            },
            substitutions: {
              q: {"5": "str(v1)", "3": "str(v2)", "2": "str(v3)"},
              a: {"5": "str(v1)", "3": "str(v2)", "2": "str(v3)"},
            },
            sourceValues: {"v1": 5, "v2": 3, "v3": 2},
          }
        },
            {
              qid: "FD_003_m03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 0. At x=9: gradient=0.0, y=6.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": 6, "max": 12, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != 6 or x_val != 9"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
              grad_at_x: {"expr": "float(deriv.subs(x, x_val))", "note": "Gradient at x_val"},
              y_at_x: {"expr": "float(expr.subs(x, x_val))", "note": "y-value at x_val"},
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 12*x**2 - 2*x + 2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -6, "max": 4, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 4 or c1 != -1 or c2 != 2"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 4, "c1": -1, "c2": 2, "c3": 0},
          }
        },
            {
              qid: "FD_003_m05",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 2*x - 4. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": 2, "max": 12, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -4 or c2 != 7"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "[Auto-fallback: Cannot convert symbols to int] Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 1 (source: 3)"},
              v2: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 2 (source: 2)"},
              v3: {"type": "int", "min": 6, "max": 16, "step": 1, "description": "Value 3 (source: 11)"},
            },
            constraints: ["v1 != 3 or v2 != 2 or v3 != 11"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "2": "str(v2)", "11": "str(v3)"},
              a: {"3": "str(v1)", "2": "str(v2)", "11": "str(v3)"},
            },
            sourceValues: {"v1": 3, "v2": 2, "v3": 11},
          }
        },
            {
              qid: "FD_003_h04",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 1. At x=4: gradient=1.0, y=4.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^1"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": 1, "max": 7, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != 1 or c1 != 0 or x_val != 4"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
              grad_at_x: {"expr": "float(deriv.subs(x, x_val))", "note": "Gradient at x_val"},
              y_at_x: {"expr": "float(expr.subs(x, x_val))", "note": "y-value at x_val"},
            ...
            sourceValues: {"c0": 1, "c1": 0, "x_val": 4},
          }
        },
            {
              qid: "FD_003_h05",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v2: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 2 (source: 5)"},
              v3: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 3 (source: 2)"},
              v4: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Value 4 (source: 6)"},
            },
            constraints: ["v1 != 3 or v2 != 5 or v3 != 2"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "5": "str(v2)", "2": "str(v3)", "6": "str(v4)"},
              a: {"3": "str(v1)", "5": "str(v2)", "2": "str(v3)", "6": "str(v4)"},
            },
            sourceValues: {"v1": 3, "v2": 5, "v3": 2, "v4": 6},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "[Auto-fallback: Cannot convert expression to float] Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 1 (source: 4)"},
            },
            constraints: ["v1 != 4"],
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 2 or v2 != 5 or v3 != 10"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "5": "str(v2)", "10": "str(v3)"},
              a: {"2": "str(v1)", "5": "str(v2)", "10": "str(v3)"},
            },
            sourceValues: {"v1": 2, "v2": 5, "v3": 10},
          }
        },
            {
              qid: "FD_NEW_03_m03",
...
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 4 or v2 != 3 or v3 != 6"],
            derived: {
            },
            substitutions: {
              q: {"4": "str(v1)", "3": "str(v2)", "6": "str(v3)", "2": "str(v4)"},
              a: {"4": "str(v1)", "3": "str(v2)", "6": "str(v3)", "2": "str(v4)"},
            },
            sourceValues: {"v1": 4, "v2": 3, "v3": 6, "v4": 2},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"3": "str(v1)", "2": "str(v2)", "5": "str(v3)", "4": "str(v4)"},
              a: {"3": "str(v1)", "2": "str(v2)", "5": "str(v3)", "4": "str(v4)"},
            },
            sourceValues: {"v1": 3, "v2": 2, "v3": 5, "v4": 4},
          }
        },
            {
              qid: "FD_004_m02",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v3: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 3 (source: 4)"},
              v4: {"type": "int", "min": -10, "max": 0, "step": 1, "description": "Value 4 (source: -5)"},
            },
            constraints: ["v1 != 2 or v2 != -3 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "-3": "str(v2)", "4": "str(v3)", "-5": "str(v4)"},
              a: {"2": "str(v1)", "-3": "str(v2)", "4": "str(v3)", "-5": "str(v4)"},
            },
            sourceValues: {"v1": 2, "v2": -3, "v3": 4, "v4": -5},
          }
        },
            {
              qid: "FD_004_m03",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v2: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Value 2 (source: -2)"},
              v3: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 3 (source: 3)"},
              v4: {"type": "int", "min": 2, "max": 12, "step": 1, "description": "Value 4 (source: 7)"},
              v5: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 5 (source: 5)"},
              v6: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Value 6 (source: 6)"},
            },
            constraints: ["v1 != 4 or v2 != -2 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"4": "str(v1)", "-2": "str(v2)", "3": "str(v3)", "7": "str(v4)", "5": "str(v5)", "6": "str(v6)"},
              a: {"4": "str(v1)", "-2": "str(v2)", "3": "str(v3)", "7": "str(v4)", "5": "str(v5)", "6": "str(v6)"},
            },
            sourceValues: {"v1": 4, "v2": -2, "v3": 3, "v4": 7, "v5": 5, "v6": 6},
          }
        },
            {
              qid: "FD_004_m04",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 1 (source: 5)"},
              v2: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 2 (source: 2)"},
              v3: {"type": "int", "min": -8, "max": 2, "step": 1, "description": "Value 3 (source: -3)"},
              v4: {"type": "int", "min": 2, "max": 12, "step": 1, "description": "Value 4 (source: 7)"},
              v5: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 5 (source: 3)"},
            },
            constraints: ["v1 != 5 or v2 != 2 or v3 != -3"],
            derived: {
            },
            substitutions: {
              q: {"5": "str(v1)", "2": "str(v2)", "-3": "str(v3)", "7": "str(v4)", "3": "str(v5)"},
              a: {"5": "str(v1)", "2": "str(v2)", "-3": "str(v3)", "7": "str(v4)", "3": "str(v5)"},
            },
            sourceValues: {"v1": 5, "v2": 2, "v3": -3, "v4": 7, "v5": 3},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v5: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Value 5 (source: 6)"},
            },
            constraints: ["v1 != 3 or v2 != -2 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "-2": "str(v2)", "4": "str(v3)", "5": "str(v4)", "6": "str(v5)"},
              a: {"3": "str(v1)", "-2": "str(v2)", "4": "str(v3)", "5": "str(v4)", "6": "str(v5)"},
            },
            sourceValues: {"v1": 3, "v2": -2, "v3": 4, "v4": 5, "v5": 6},
          }
        },
            {
              qid: "FD_004_h02",
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"2": "str(v1)", "3": "str(v2)", "-2": "str(v3)", "4": "str(v4)", "5": "str(v5)"},
              a: {"2": "str(v1)", "3": "str(v2)", "-2": "str(v3)", "4": "str(v4)", "5": "str(v5)"},
            },
            sourceValues: {"v1": 2, "v2": 3, "v3": -2, "v4": 4, "v5": 5},
          }
        },
            {
              qid: "FD_004_h04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 6 or v2 != -2 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"6": "str(v1)", "-2": "str(v2)", "3": "str(v3)", "4": "str(v4)"},
              a: {"6": "str(v1)", "-2": "str(v2)", "3": "str(v3)", "4": "str(v4)"},
            },
            sourceValues: {"v1": 6, "v2": -2, "v3": 3, "v4": 4},
          }
        },
            {
              qid: "FD_004_h05",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v3: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 3 (source: 3)"},
              v4: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 4 (source: 4)"},
              v5: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Value 5 (source: -2)"},
            },
            constraints: ["v1 != 2 or v2 != 5 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "5": "str(v2)", "3": "str(v3)", "4": "str(v4)", "-2": "str(v5)"},
              a: {"2": "str(v1)", "5": "str(v2)", "3": "str(v3)", "4": "str(v4)", "-2": "str(v5)"},
            },
            sourceValues: {"v1": 2, "v2": 5, "v3": 3, "v4": 4, "v5": -2},
          }
        }
          ]
        }
...
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 - 6. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -11, "max": -1, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != -6"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -6, "c3": 0},
          }
        },
            {
              qid: "FD_NEW_05_e02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4*x**3 + 2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != 0"],
            derived: {
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": 0, "c3": 2, "c4": 0},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 12*x**3. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 3 or c1 != 0 or c2 != 0"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 3, "c1": 0, "c2": 0, "c3": 0, "c4": 2},
          }
        },
            {
              qid: "FD_NEW_05_m02",
...
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 2 or v2 != 6 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "6": "str(v2)", "3": "str(v3)", "4": "str(v4)", "-2": "str(v5)"},
              a: {"2": "str(v1)", "6": "str(v2)", "3": "str(v3)", "4": "str(v4)", "-2": "str(v5)"},
            },
            sourceValues: {"v1": 2, "v2": 6, "v3": 3, "v4": 4, "v5": -2},
          }
        },
            {
              qid: "FD_006_e02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 3 or v2 != 9 or v3 != 6"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "9": "str(v2)", "6": "str(v3)"},
              a: {"3": "str(v1)", "9": "str(v2)", "6": "str(v3)"},
            },
            sourceValues: {"v1": 3, "v2": 9, "v3": 6},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 4 or v2 != 10 or v3 != 2"],
            derived: {
            },
            substitutions: {
              q: {"4": "str(v1)", "10": "str(v2)", "2": "str(v3)", "3": "str(v4)"},
              a: {"4": "str(v1)", "10": "str(v2)", "2": "str(v3)", "3": "str(v4)"},
            },
            sourceValues: {"v1": 4, "v2": 10, "v3": 2, "v4": 3},
          }
        },
            {
              qid: "FD_006_m04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != -2 or v2 != 7 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"-2": "str(v1)", "7": "str(v2)", "4": "str(v3)"},
              a: {"-2": "str(v1)", "7": "str(v2)", "4": "str(v3)"},
            },
            sourceValues: {"v1": -2, "v2": 7, "v3": 4},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v2: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Value 2 (source: -4)"},
              v3: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 3 (source: 5)"},
              v4: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Value 4 (source: -2)"},
              v5: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Value 5 (source: 6)"},
            },
            constraints: ["v1 != 3 or v2 != -4 or v3 != 5"],
            derived: {
            ...
            substitutions: {
              q: {"3": "str(v1)", "-4": "str(v2)", "5": "str(v3)", "-2": "str(v4)", "6": "str(v5)"},
              a: {"3": "str(v1)", "-4": "str(v2)", "5": "str(v3)", "-2": "str(v4)", "6": "str(v5)"},
            },
            sourceValues: {"v1": 3, "v2": -4, "v3": 5, "v4": -2, "v5": 6},
          }
        },
            {
              qid: "FD_006_h02",
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"-2": "str(v1)", "8": "str(v2)", "-3": "str(v3)", "4": "str(v4)", "7": "str(v5)"},
              a: {"-2": "str(v1)", "8": "str(v2)", "-3": "str(v3)", "4": "str(v4)", "7": "str(v5)"},
            },
            sourceValues: {"v1": -2, "v2": 8, "v3": -3, "v4": 4, "v5": 7},
          }
        },
            {
              qid: "FD_006_h04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 5 or v2 != 12 or v3 != -4"],
            derived: {
            },
            substitutions: {
              q: {"5": "str(v1)", "12": "str(v2)", "-4": "str(v3)", "6": "str(v4)"},
              a: {"5": "str(v1)", "12": "str(v2)", "-4": "str(v3)", "6": "str(v4)"},
            },
            sourceValues: {"v1": 5, "v2": 12, "v3": -4, "v4": 6},
          }
        },
            {
              qid: "FD_006_h05",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": -10, "max": 0, "step": 1, "description": "Value 1 (source: -5)"},
              v2: {"type": "int", "min": 5, "max": 15, "step": 1, "description": "Value 2 (source: 10)"},
              v3: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 3 (source: 3)"},
              v4: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Value 4 (source: -4)"},
            },
            constraints: ["v1 != -5 or v2 != 10 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"-5": "str(v1)", "10": "str(v2)", "3": "str(v3)", "-4": "str(v4)"},
              a: {"-5": "str(v1)", "10": "str(v2)", "3": "str(v3)", "-4": "str(v4)"},
            },
            sourceValues: {"v1": -5, "v2": 10, "v3": 3, "v4": -4},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["c0 != 1 or c1 != -4 or c2 != 3"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 6 - 2*x. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -6, "max": 4, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != -1 or c1 != 6 or c2 != 0"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4 - 2*x. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -6, "max": 4, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": -24, "max": -8, "step": 1, "description": "Value 1 (source: -16)"},
              v2: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Value 2 (source: -4)"},
              v3: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 3 (source: 4)"},
            },
            constraints: ["v1 != -16 or v2 != -4 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"-16": "str(v1)", "-4": "str(v2)", "4": "str(v3)"},
              a: {"-16": "str(v1)", "-4": "str(v2)", "4": "str(v3)"},
            },
            sourceValues: {"v1": -16, "v2": -4, "v3": 4},
          }
        },
            {
              qid: "FD_NEW_06_m02",
          ...
          seedSpec: {
            ...
            reason: "Polynomial differentiation. f'(x) = 0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 2"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4*x**3 - 12*x**2 + 16. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": 11, "max": 21, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -21, "max": -11, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -4 or c2 != 0"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            ...
            sourceValues: {"c0": 1, "c1": -4, "c2": 0, "c3": 16, "c4": -16},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 1. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^1"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 0"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Coefficient of x^1"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 3 or c1 != 0"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": 0, "c3": 0},
          }
        },
            {
              qid: "FD_007_m02",
          ...
          seedSpec: {
            ...
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^1"},
              c1: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 1"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 8*x - 4. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 4 or c1 != -4 or c2 != 1"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
...
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 20 or v2 != 3"],
            derived: {
            },
            substitutions: {
              q: {"20": "str(v1)", "3": "str(v2)"},
              a: {"20": "str(v1)", "3": "str(v2)"},
            },
            sourceValues: {"v1": 20, "v2": 3},
          }
        },
            {
              qid: "FD_NEW_07_m02",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Value 1 (source: 1)"},
              v2: {"type": "float", "min": 0.3, "max": 1.3, "step": 0.05, "description": "Value 2 (source: 0.8)"},
            },
            constraints: ["v1 != 1 or v2 != 0.8"],
            derived: {
            },
            substitutions: {
              q: {"1": "str(v1)", "0.8": "str(v2)"},
              a: {"1": "str(v1)", "0.8": "str(v2)"},
            },
            sourceValues: {"v1": 1, "v2": 0.8},
          }
        },
            {
              qid: "FD_NEW_07_m03",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 50, "max": 148, "step": 5, "description": "Value 1 (source: 99)"},
              v2: {"type": "int", "min": 50, "max": 150, "step": 5, "description": "Value 2 (source: 100)"},
            },
            constraints: ["v1 != 99 or v2 != 100"],
            derived: {
            },
            substitutions: {
              q: {"99": "str(v1)", "100": "str(v2)"},
              a: {"99": "str(v1)", "100": "str(v2)"},
            },
            sourceValues: {"v1": 99, "v2": 100},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v2: {"type": "int", "min": 151, "max": 453, "step": 5, "description": "Value 2 (source: 302)"},
            },
            constraints: ["v1 != 300 or v2 != 302"],
            derived: {
            },
            substitutions: {
              q: {"300": "str(v1)", "302": "str(v2)"},
              a: {"300": "str(v1)", "302": "str(v2)"},
            },
            sourceValues: {"v1": 300, "v2": 302},
          }
        }
          ]
        }
...
,

    {
          ...
          seedSpec: {
            ...
            reason: "Polynomial differentiation. f'(x) = 0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -8, "max": 2, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != -3"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
...
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 3 or v2 != 2 or v3 != -3"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "2": "str(v2)", "-3": "str(v3)"},
              a: {"3": "str(v1)", "2": "str(v2)", "-3": "str(v3)"},
            },
            sourceValues: {"v1": 3, "v2": 2, "v3": -3},
          }
        }
          ],
          hard: [
...
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 20 or v2 != 10"],
            derived: {
            },
            substitutions: {
              q: {"20": "str(v1)", "10": "str(v2)"},
              a: {"20": "str(v1)", "10": "str(v2)"},
            },
            sourceValues: {"v1": 20, "v2": 10},
          }
        },
            {
              qid: "FD_028_e02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 75 or v2 != 4"],
            derived: {
            },
            substitutions: {
              q: {"75": "str(v1)", "4": "str(v2)"},
              a: {"75": "str(v1)", "4": "str(v2)"},
            },
            sourceValues: {"v1": 75, "v2": 4},
          }
        },
            {
              qid: "FD_028_e03",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 15, "max": 45, "step": 5, "description": "Value 1 (source: 30)"},
              v2: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 2 (source: 2)"},
            },
            constraints: ["v1 != 30 or v2 != 2"],
            derived: {
            },
            substitutions: {
              q: {"30": "str(v1)", "2": "str(v2)"},
              a: {"30": "str(v1)", "2": "str(v2)"},
            },
            sourceValues: {"v1": 30, "v2": 2},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 48 or v2 != 12 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"48": "str(v1)", "12": "str(v2)", "4": "str(v3)"},
              a: {"48": "str(v1)", "12": "str(v2)", "4": "str(v3)"},
            },
            sourceValues: {"v1": 48, "v2": 12, "v3": 4},
          }
        },
            {
              qid: "FD_028_m02",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v2: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 2 (source: 2)"},
              v3: {"type": "int", "min": 100, "max": 300, "step": 5, "description": "Value 3 (source: 200)"},
            },
            constraints: ["v1 != 100 or v2 != 2 or v3 != 200"],
            derived: {
            },
            substitutions: {
              q: {"100": "str(v1)", "2": "str(v2)", "200": "str(v3)"},
              a: {"100": "str(v1)", "2": "str(v2)", "200": "str(v3)"},
            },
            sourceValues: {"v1": 100, "v2": 2, "v3": 200},
          }
        },
            {
              qid: "FD_028_m03",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 60, "max": 180, "step": 5, "description": "Value 1 (source: 120)"},
              v2: {"type": "int", "min": 30, "max": 90, "step": 5, "description": "Value 2 (source: 60)"},
              v3: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 3 (source: 3)"},
              v4: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 4 (source: 2)"},
            },
            constraints: ["v1 != 120 or v2 != 60 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"120": "str(v1)", "60": "str(v2)", "3": "str(v3)", "2": "str(v4)"},
              a: {"120": "str(v1)", "60": "str(v2)", "3": "str(v3)", "2": "str(v4)"},
            },
            sourceValues: {"v1": 120, "v2": 60, "v3": 3, "v4": 2},
          }
        },
            {
              qid: "FD_028_m04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 2 or v2 != 10 or v3 != 5"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "10": "str(v2)", "5": "str(v3)"},
              a: {"2": "str(v1)", "10": "str(v2)", "5": "str(v3)"},
            },
            sourceValues: {"v1": 2, "v2": 10, "v3": 5},
          }
        },
            {
              qid: "FD_028_m05",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v2: {"type": "int", "min": 6, "max": 18, "step": 1, "description": "Value 2 (source: 12)"},
              v3: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 3 (source: 4)"},
              v4: {"type": "int", "min": 32, "max": 96, "step": 5, "description": "Value 4 (source: 64)"},
              v5: {"type": "int", "min": 120, "max": 360, "step": 5, "description": "Value 5 (source: 240)"},
            },
            constraints: ["v1 != 20 or v2 != 12 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"20": "str(v1)", "12": "str(v2)", "4": "str(v3)", "64": "str(v4)", "240": "str(v5)"},
              a: {"20": "str(v1)", "12": "str(v2)", "4": "str(v3)", "64": "str(v4)", "240": "str(v5)"},
            },
            sourceValues: {"v1": 20, "v2": 12, "v3": 4, "v4": 64, "v5": 240},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 6 or v2 != 12 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"6": "str(v1)", "12": "str(v2)", "3": "str(v3)"},
              a: {"6": "str(v1)", "12": "str(v2)", "3": "str(v3)"},
            },
            sourceValues: {"v1": 6, "v2": 12, "v3": 3},
          }
        },
            {
              qid: "FD_028_h02",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 75, "max": 225, "step": 5, "description": "Value 1 (source: 150)"},
              v2: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 2 (source: 3)"},
              v3: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 3 (source: 4)"},
              v4: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Value 4 (source: 6)"},
              v5: {"type": "int", "min": 3, "max": 13, "step": 1, "description": "Value 5 (source: 8)"},
            },
            constraints: ["v1 != 150 or v2 != 3 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"150": "str(v1)", "3": "str(v2)", "4": "str(v3)", "6": "str(v4)", "8": "str(v5)"},
              a: {"150": "str(v1)", "3": "str(v2)", "4": "str(v3)", "6": "str(v4)", "8": "str(v5)"},
            },
            sourceValues: {"v1": 150, "v2": 3, "v3": 4, "v4": 6, "v5": 8},
          }
        },
            {
              qid: "FD_028_h03",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v3: {"type": "int", "min": 5, "max": 15, "step": 1, "description": "Value 3 (source: 10)"},
              v4: {"type": "int", "min": 20, "max": 60, "step": 5, "description": "Value 4 (source: 40)"},
            },
            constraints: ["v1 != 50 or v2 != 200 or v3 != 10"],
            derived: {
            },
            substitutions: {
              q: {"50": "str(v1)", "200": "str(v2)", "10": "str(v3)", "40": "str(v4)"},
              a: {"50": "str(v1)", "200": "str(v2)", "10": "str(v3)", "40": "str(v4)"},
            },
            sourceValues: {"v1": 50, "v2": 200, "v3": 10, "v4": 40},
          }
        },
            {
              qid: "FD_028_h05",
...
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 8 or v2 != 20"],
            derived: {
            },
            substitutions: {
              q: {"8": "str(v1)", "20": "str(v2)"},
              a: {"8": "str(v1)", "20": "str(v2)"},
            },
            sourceValues: {"v1": 8, "v2": 20},
          }
        },
            {
              qid: "FD_029_e03",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 20, "max": 60, "step": 5, "description": "Value 1 (source: 40)"},
              v2: {"type": "int", "min": 100, "max": 300, "step": 5, "description": "Value 2 (source: 200)"},
            },
            constraints: ["v1 != 40 or v2 != 200"],
            derived: {
            },
            substitutions: {
              q: {"40": "str(v1)", "200": "str(v2)"},
              a: {"40": "str(v1)", "200": "str(v2)"},
            },
            sourceValues: {"v1": 40, "v2": 200},
          }
        },
            {
              qid: "FD_029_m05",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 15, "max": 45, "step": 5, "description": "Value 1 (source: 30)"},
              v2: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 2 (source: 2)"},
              v3: {"type": "int", "min": 8, "max": 22, "step": 1, "description": "Value 3 (source: 15)"},
            },
            constraints: ["v1 != 30 or v2 != 2 or v3 != 15"],
            derived: {
            },
            substitutions: {
              q: {"30": "str(v1)", "2": "str(v2)", "15": "str(v3)"},
              a: {"30": "str(v1)", "2": "str(v2)", "15": "str(v3)"},
            },
            sourceValues: {"v1": 30, "v2": 2, "v3": 15},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 32 or v2 != 2"],
            derived: {
            },
            substitutions: {
              q: {"32": "str(v1)", "2": "str(v2)"},
              a: {"32": "str(v1)", "2": "str(v2)"},
            },
            sourceValues: {"v1": 32, "v2": 2},
          }
        },
            {
              qid: "FD_029_h02",
          ...
          seedSpec: {
            ...
            reason: "Polynomial differentiation. f'(x) = 0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": 19, "max": 29, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 24"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
...
,

    {
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 8, "max": 22, "step": 1, "description": "Value 1 (source: 15)"},
              v2: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 2 (source: 5)"},
            },
            constraints: ["v1 != 15 or v2 != 5"],
            derived: {
            },
            substitutions: {
              q: {"15": "str(v1)", "5": "str(v2)"},
              a: {"15": "str(v1)", "5": "str(v2)"},
            },
            sourceValues: {"v1": 15, "v2": 5},
          }
        },
            {
              qid: "FD_030_e02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 3 or v2 != 10 or v3 != 50"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "10": "str(v2)", "50": "str(v3)"},
              a: {"3": "str(v1)", "10": "str(v2)", "50": "str(v3)"},
            },
            sourceValues: {"v1": 3, "v2": 10, "v3": 50},
          }
        },
            {
              qid: "FD_030_e03",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v3: {"type": "int", "min": 18, "max": 54, "step": 5, "description": "Value 3 (source: 36)"},
              v4: {"type": "int", "min": 50, "max": 150, "step": 5, "description": "Value 4 (source: 100)"},
              v5: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 5 (source: 3)"},
            },
            constraints: ["v1 != 2 or v2 != 15 or v3 != 36"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "15": "str(v2)", "36": "str(v3)", "100": "str(v4)", "3": "str(v5)"},
              a: {"2": "str(v1)", "15": "str(v2)", "36": "str(v3)", "100": "str(v4)", "3": "str(v5)"},
            },
            sourceValues: {"v1": 2, "v2": 15, "v3": 36, "v4": 100, "v5": 3},
          }
        },
            {
              qid: "FD_030_m03",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v4: {"type": "int", "min": 100, "max": 300, "step": 5, "description": "Value 4 (source: 200)"},
              v5: {"type": "int", "min": 7, "max": 21, "step": 1, "description": "Value 5 (source: 14)"},
            },
            constraints: ["v1 != 4 or v2 != 8 or v3 != 60"],
            derived: {
            },
            substitutions: {
              q: {"4": "str(v1)", "8": "str(v2)", "60": "str(v3)", "200": "str(v4)", "14": "str(v5)"},
              a: {"4": "str(v1)", "8": "str(v2)", "60": "str(v3)", "200": "str(v4)", "14": "str(v5)"},
            },
            sourceValues: {"v1": 4, "v2": 8, "v3": 60, "v4": 200, "v5": 14},
          }
        },
            {
              qid: "FD_030_m05",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 100 or v2 != 5 or v3 != 15"],
            derived: {
            },
            substitutions: {
              q: {"100": "str(v1)", "5": "str(v2)", "15": "str(v3)"},
              a: {"100": "str(v1)", "5": "str(v2)", "15": "str(v3)"},
            },
            sourceValues: {"v1": 100, "v2": 5, "v3": 15},
          }
        },
            {
              qid: "FD_030_h03",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 100, "max": 300, "step": 5, "description": "Value 1 (source: 200)"},
              v2: {"type": "int", "min": 75, "max": 225, "step": 5, "description": "Value 2 (source: 150)"},
              v3: {"type": "int", "min": 25, "max": 75, "step": 5, "description": "Value 3 (source: 50)"},
            },
            constraints: ["v1 != 200 or v2 != 150 or v3 != 50"],
            derived: {
            },
            substitutions: {
              q: {"200": "str(v1)", "150": "str(v2)", "50": "str(v3)"},
              a: {"200": "str(v1)", "150": "str(v2)", "50": "str(v3)"},
            },
            sourceValues: {"v1": 200, "v2": 150, "v3": 50},
          }
        },
            {
              qid: "FD_030_h05",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 3 or v2 != 6 or v3 != 12"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "6": "str(v2)", "12": "str(v3)"},
              a: {"3": "str(v1)", "6": "str(v2)", "12": "str(v3)"},
            },
            sourceValues: {"v1": 3, "v2": 6, "v3": 12},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 15*x**2 - 4*x + 7. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": 2, "max": 12, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -6, "max": 4, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 5 or c1 != -2 or c2 != 7"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 5, "c1": -2, "c2": 7, "c3": -1},
          }
        },
            {
              qid: "FD_031_e02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4*x**3 - 9*x**2 + 2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -8, "max": 2, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            ...
            sourceValues: {"c0": 1, "c1": -3, "c2": 0, "c3": 2, "c4": 0},
          }
        },
            {
              qid: "FD_031_m02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 8*(2*x + 1)**3. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": 11, "max": 21, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": 27, "max": 37, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": 19, "max": 29, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": 3, "max": 13, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 16 or c1 != 32 or c2 != 24"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 16, "c1": 32, "c2": 24, "c3": 8, "c4": 1},
          }
        },
            {
              qid: "FD_031_m04",
...
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 3 or v2 != 2 or v3 != 7"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "2": "str(v2)", "7": "str(v3)"},
              a: {"3": "str(v1)", "2": "str(v2)", "7": "str(v3)"},
            },
            sourceValues: {"v1": 3, "v2": 2, "v3": 7},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 10 or v2 != 2 or v3 != 6"],
            derived: {
            },
            substitutions: {
              q: {"10": "str(v1)", "2": "str(v2)", "6": "str(v3)"},
              a: {"10": "str(v1)", "2": "str(v2)", "6": "str(v3)"},
            },
            sourceValues: {"v1": 10, "v2": 2, "v3": 6},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Value 1 (source: 6)"},
              v2: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 2 (source: 2)"},
              v3: {"type": "int", "min": -31, "max": -11, "step": 5, "description": "Value 3 (source: -21)"},
            },
            constraints: ["v1 != 6 or v2 != 2 or v3 != -21"],
            derived: {
            },
            substitutions: {
              q: {"6": "str(v1)", "2": "str(v2)", "-21": "str(v3)"},
              a: {"6": "str(v1)", "2": "str(v2)", "-21": "str(v3)"},
            },
            sourceValues: {"v1": 6, "v2": 2, "v3": -21},
          }
        },
            {
              qid: "FD_032_h02",
...
,

    {
          ...
          seedSpec: {
            ...
            sourceValues: {"c0": 1, "c1": -3, "c2": 0, "c3": 0},
          }
        },
            {
              qid: "FD_033_e02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 12 - 3*x**2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -6, "max": 4, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": 7, "max": 17, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != -1 or c1 != 0 or c2 != 12"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": -1, "c1": 0, "c2": 12, "c3": 0},
          }
        },
            {
              qid: "FD_033_e03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 6*x**2 - 12*x + 1. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -11, "max": -1, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 2 or c1 != -6 or c2 != 1"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 2, "c1": -6, "c2": 1, "c3": 5},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 - 12*x + 9. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -11, "max": -1, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": 4, "max": 14, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -6 or c2 != 9"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": -6, "c2": 9, "c3": 0},
          }
        },
            {
              qid: "FD_033_m02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4*x**3 - 16*x. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -13, "max": -3, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != -8"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -8, "c3": 0, "c4": 0},
          }
        },
            {
              qid: "FD_033_m03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 - 12*x + 12. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -11, "max": -1, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": 7, "max": 17, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -8, "max": 2, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -6 or c2 != 12"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": -6, "c2": 12, "c3": -3},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4*x**3 - 12*x**2 + 12*x. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -4 or c2 != 6"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": -4, "c2": 6, "c3": 0, "c4": 0},
          }
        },
            {
              qid: "FD_033_h02",
...
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 - 6. At x=2: gradient=6.0, y=-3.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -11, "max": -1, "step": 1, "description": "Coefficient of x^1"},
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -6, "c3": 1, "x_val": 2},
          }
        },
            {
              qid: "FD_034_e02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = -6*x**2 + 6*x. At x=3: gradient=-36.0, y=-22.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": 0, "max": 6, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != -2 or c1 != 3 or c2 != 0"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
              grad_at_x: {"expr": "float(deriv.subs(x, x_val))", "note": "Gradient at x_val"},
              y_at_x: {"expr": "float(expr.subs(x, x_val))", "note": "y-value at x_val"},
            ...
            sourceValues: {"c0": -2, "c1": 3, "c2": 0, "c3": 5, "x_val": 3},
          }
        },
            {
              qid: "FD_034_e03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4*x**3 - 8*x. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": -3, "max": 3, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != -4"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -4, "c3": 0, "c4": 0, "x_val": 0},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 1. At x=1: gradient=1.0, y=1.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^1"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": -2, "max": 4, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != 1 or c1 != 0 or x_val != 1"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
              grad_at_x: {"expr": "float(deriv.subs(x, x_val))", "note": "Gradient at x_val"},
              y_at_x: {"expr": "float(expr.subs(x, x_val))", "note": "y-value at x_val"},
            ...
            sourceValues: {"c0": 1, "c1": 0, "x_val": 1},
          }
        },
            {
              qid: "FD_034_m02",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Value 1 (source: 1)"},
              v2: {"type": "int", "min": -6, "max": 4, "step": 1, "description": "Value 2 (source: -1)"},
            },
...
,

    {
          ...
          seedSpec: {
            ...
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -11, "max": -1, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": 5, "max": 15, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -6 or c2 != 10"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            ...
            constraints: ["c0 != -1 or c1 != 4 or c2 != 1"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 - 12. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -17, "max": -7, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != -12"],
            derived: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 - 3. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -8, "max": 2, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != -3"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -3, "c3": 2},
          }
        },
            {
              qid: "FD_035_m02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 12*x**3 - 12*x**2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
            ...
            constraints: ["c0 != 3 or c1 != -4 or c2 != 0"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 3, "c1": -4, "c2": 0, "c3": 0, "c4": 0},
          }
        },
            {
              qid: "FD_035_m03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 - 6*x - 9. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -8, "max": 2, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -14, "max": -4, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -3 or c2 != -9"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": -3, "c2": -9, "c3": 5},
          }
        },
            {
              qid: "FD_035_m05",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 6*x**2 + 6*x - 36. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -41, "max": -31, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": 5, "max": 15, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 2 or c1 != 3 or c2 != -36"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 2, "c1": 3, "c2": -36, "c3": 10},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4*x**3 - 12*x**2 + 8*x. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -4 or c2 != 4"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": -4, "c2": 4, "c3": 0, "c4": 0},
          }
        },
            {
              qid: "FD_035_h02",
...
,

    {
          ...
          seedSpec: {
            ...
            parameters: {
              c0: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Coefficient of x^1"},
              c1: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 2 or c1 != 6"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
...
,

    {
          ...
          seedSpec: {
            ...
            sourceValues: {"c0": 1, "c1": -6, "c2": 12, "c3": 0},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4*x**3 - 12*x + 8. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -11, "max": -1, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": 3, "max": 13, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != -6"],
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -6, "c3": 8, "c4": 0},
          }
        },
            {
              qid: "FD_037_m03",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              c2: {"type": "int", "min": -13, "max": -3, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != -8"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -8, "c3": 0, "c4": 3},
          }
        },
            {
              qid: "FD_037_h02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4*x*(x**2 - 1). Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Coefficient of x^2"},
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -2, "c3": 0, "c4": 1},
          }
        },
            {
              qid: "FD_037_h05",
...
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 6 or v2 != 15"],
            derived: {
            },
            substitutions: {
              q: {"6": "str(v1)", "15": "str(v2)"},
              a: {"6": "str(v1)", "15": "str(v2)"},
            },
            sourceValues: {"v1": 6, "v2": 15},
          }
        },
            {
              qid: "FD_038_e02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != -2 or v2 != 18 or v3 != 10"],
            derived: {
            },
            substitutions: {
              q: {"-2": "str(v1)", "18": "str(v2)", "10": "str(v3)"},
              a: {"-2": "str(v1)", "18": "str(v2)", "10": "str(v3)"},
            },
            sourceValues: {"v1": -2, "v2": 18, "v3": 10},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 500, "max": 1500, "step": 5, "description": "Value 1 (source: 1000)"},
              v2: {"type": "int", "min": 4, "max": 14, "step": 1, "description": "Value 2 (source: 9)"},
            },
            constraints: ["v1 != 1000 or v2 != 9"],
            derived: {
            },
            substitutions: {
              q: {"1000": "str(v1)", "9": "str(v2)"},
              a: {"1000": "str(v1)", "9": "str(v2)"},
            },
            sourceValues: {"v1": 1000, "v2": 9},
          }
        },
            {
              qid: "FD_038_m02",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v2: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 2 (source: 2)"},
              v3: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 3 (source: 3)"},
              v4: {"type": "int", "min": 12, "max": 36, "step": 5, "description": "Value 4 (source: 24)"},
            },
            constraints: ["v1 != 4 or v2 != 2 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"4": "str(v1)", "2": "str(v2)", "3": "str(v3)", "24": "str(v4)"},
              a: {"4": "str(v1)", "2": "str(v2)", "3": "str(v3)", "24": "str(v4)"},
            },
            sourceValues: {"v1": 4, "v2": 2, "v3": 3, "v4": 24},
          }
        },
            {
              qid: "FD_038_m03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 500 or v2 != 24"],
            derived: {
            },
            substitutions: {
              q: {"500": "str(v1)", "24": "str(v2)"},
              a: {"500": "str(v1)", "24": "str(v2)"},
            },
            sourceValues: {"v1": 500, "v2": 24},
          }
        },
            {
              qid: "FD_038_m04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 100 or v2 != 2"],
            derived: {
            },
            substitutions: {
              q: {"100": "str(v1)", "2": "str(v2)"},
              a: {"100": "str(v1)", "2": "str(v2)"},
            },
            sourceValues: {"v1": 100, "v2": 2},
          }
        },
            {
              qid: "FD_038_m05",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 5000, "max": 15000, "step": 5, "description": "Value 1 (source: 10000)"},
              v2: {"type": "int", "min": 25, "max": 73, "step": 5, "description": "Value 2 (source: 49)"},
            },
            constraints: ["v1 != 10000 or v2 != 49"],
            derived: {
            },
            substitutions: {
              q: {"10000": "str(v1)", "49": "str(v2)"},
              a: {"10000": "str(v1)", "49": "str(v2)"},
            },
            sourceValues: {"v1": 10000, "v2": 49},
          }
        },
            {
              qid: "FD_038_h02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 20 or v2 != 3 or v3 != 10"],
            derived: {
            },
            substitutions: {
              q: {"20": "str(v1)", "3": "str(v2)", "10": "str(v3)"},
              a: {"20": "str(v1)", "3": "str(v2)", "10": "str(v3)"},
            },
            sourceValues: {"v1": 20, "v2": 3, "v3": 10},
          }
        },
            {
              qid: "FD_038_h03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 50 or v2 != 4"],
            derived: {
            },
            substitutions: {
              q: {"50": "str(v1)", "4": "str(v2)"},
              a: {"50": "str(v1)", "4": "str(v2)"},
            },
            sourceValues: {"v1": 50, "v2": 4},
          }
        },
            {
              qid: "FD_038_h04",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 2500, "max": 7500, "step": 5, "description": "Value 1 (source: 5000)"},
              v2: {"type": "int", "min": 2400, "max": 7200, "step": 5, "description": "Value 2 (source: 4800)"},
              v3: {"type": "int", "min": 100, "max": 300, "step": 5, "description": "Value 3 (source: 200)"},
            },
            constraints: ["v1 != 5000 or v2 != 4800 or v3 != 200"],
            derived: {
            },
            substitutions: {
              q: {"5000": "str(v1)", "4800": "str(v2)", "200": "str(v3)"},
              a: {"5000": "str(v1)", "4800": "str(v2)", "200": "str(v3)"},
            },
            sourceValues: {"v1": 5000, "v2": 4800, "v3": 200},
          }
        },
            {
              qid: "FD_038_h05",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v2: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 2 (source: 4)"},
              v3: {"type": "int", "min": 5, "max": 15, "step": 1, "description": "Value 3 (source: 10)"},
              v4: {"type": "int", "min": 18, "max": 54, "step": 5, "description": "Value 4 (source: 36)"},
              v5: {"type": "int", "min": 24, "max": 72, "step": 5, "description": "Value 5 (source: 48)"},
            },
            constraints: ["v1 != 3 or v2 != 4 or v3 != 10"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "4": "str(v2)", "10": "str(v3)", "36": "str(v4)", "48": "str(v5)"},
              a: {"3": "str(v1)", "4": "str(v2)", "10": "str(v3)", "36": "str(v4)", "48": "str(v5)"},
            },
            sourceValues: {"v1": 3, "v2": 4, "v3": 10, "v4": 36, "v5": 48},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -3, "c3": 0},
          }
        },
            {
              qid: "FD_039_e03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4*x**3 - 12*x**2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
            ...
            sourceValues: {"c0": 1, "c1": -4, "c2": 0, "c3": 0, "c4": 0},
          }
        },
            {
              qid: "FD_039_m04",
          ...
          seedSpec: {
            ...
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -13, "max": -3, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -2 or c2 != -8"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              c1: {"type": "int", "min": -8, "max": 2, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -14, "max": -4, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": 22, "max": 32, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -3 or c2 != -9"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            ...
            sourceValues: {"c0": 1, "c1": -3, "c2": -9, "c3": 27},
          }
        },
            {
              qid: "FD_039_h02",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              c2: {"type": "int", "min": -13, "max": -3, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": 11, "max": 21, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != -8"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -8, "c3": 0, "c4": 16},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 2 or v2 != 5 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "5": "str(v2)", "4": "str(v3)"},
              a: {"2": "str(v1)", "5": "str(v2)", "4": "str(v3)"},
            },
            sourceValues: {"v1": 2, "v2": 5, "v3": 4},
          }
        },
            {
              qid: "FD_040_e02",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v5: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 5 (source: 2)"},
            },
            constraints: ["v1 != -3 or v2 != 3 or v3 != 6"],
            derived: {
            },
            substitutions: {
              q: {"-3": "str(v1)", "3": "str(v2)", "6": "str(v3)", "9": "str(v4)", "2": "str(v5)"},
              a: {"-3": "str(v1)", "3": "str(v2)", "6": "str(v3)", "9": "str(v4)", "2": "str(v5)"},
            },
            sourceValues: {"v1": -3, "v2": 3, "v3": 6, "v4": 9, "v5": 2},
          }
        },
            {
              qid: "FD_040_e03",
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"2": "str(v1)", "3": "str(v2)", "5": "str(v3)", "4": "str(v4)"},
              a: {"2": "str(v1)", "3": "str(v2)", "5": "str(v3)", "4": "str(v4)"},
            },
            sourceValues: {"v1": 2, "v2": 3, "v3": 5, "v4": 4},
          }
        },
            {
              qid: "FD_040_m02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 3 or v2 != -2 or v3 != 2"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "-2": "str(v2)", "2": "str(v3)", "4": "str(v4)"},
              a: {"3": "str(v1)", "-2": "str(v2)", "2": "str(v3)", "4": "str(v4)"},
            },
            sourceValues: {"v1": 3, "v2": -2, "v3": 2, "v4": 4},
          }
        },
            {
              qid: "FD_040_m03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 2 or v2 != 4 or v3 != -5"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "4": "str(v2)", "-5": "str(v3)"},
              a: {"2": "str(v1)", "4": "str(v2)", "-5": "str(v3)"},
            },
            sourceValues: {"v1": 2, "v2": 4, "v3": -5},
          }
        },
            {
              qid: "FD_040_m04",
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"-2": "str(v1)", "3": "str(v2)", "5": "str(v3)", "10": "str(v4)"},
              a: {"-2": "str(v1)", "3": "str(v2)", "5": "str(v3)", "10": "str(v4)"},
            },
            sourceValues: {"v1": -2, "v2": 3, "v3": 5, "v4": 10},
          }
        },
            {
              qid: "FD_040_h03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 0. At x=2: gradient=0.0, y=1.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": -1, "max": 5, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != 1 or x_val != 2"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
              grad_at_x: {"expr": "float(deriv.subs(x, x_val))", "note": "Gradient at x_val"},
              y_at_x: {"expr": "float(expr.subs(x, x_val))", "note": "y-value at x_val"},
...
,

    {
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": 0.52, "max": 1.52, "step": 0.05, "description": "Value 1 (source: 1.02)"},
            },
            constraints: ["v1 != 1.02"],
            derived: {
            },
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": 3.52, "max": 4.52, "step": 0.05, "description": "Value 1 (source: 4.02)"},
              v2: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 2 (source: 4)"},
              v3: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 3 (source: 2)"},
            },
            constraints: ["v1 != 4.02 or v2 != 4 or v3 != 2"],
            derived: {
            },
            substitutions: {
              q: {"4.02": "str(v1)", "4": "str(v2)", "2": "str(v3)"},
              a: {"4.02": "str(v1)", "4": "str(v2)", "2": "str(v3)"},
            },
            sourceValues: {"v1": 4.02, "v2": 4, "v3": 2},
          }
        },
            {
              qid: "FD_041_h04",
...
,

    {
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 1 (source: 5)"},
              v2: {"type": "float", "min": 4.52, "max": 5.52, "step": 0.05, "description": "Value 2 (source: 5.02)"},
            },
            constraints: ["v1 != 5 or v2 != 5.02"],
            derived: {
            },
            substitutions: {
              q: {"5": "str(v1)", "5.02": "str(v2)"},
              a: {"5": "str(v1)", "5.02": "str(v2)"},
            },
            sourceValues: {"v1": 5, "v2": 5.02},
          }
        },
            {
              qid: "FD_042_m02",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": 36.0, "max": 37.0, "step": 0.05, "description": "Value 1 (source: 36.5)"},
            },
            constraints: ["v1 != 36.5"],
            derived: {
            },
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": -0.52, "max": 0.48, "step": 0.05, "description": "Value 1 (source: -0.02)"},
            },
            constraints: ["v1 != -0.02"],
            derived: {
            },
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 16, "max": 46, "step": 5, "description": "Value 1 (source: 31)"},
              v2: {"type": "int", "min": 15, "max": 45, "step": 5, "description": "Value 2 (source: 30)"},
              v3: {"type": "int", "min": 90, "max": 270, "step": 5, "description": "Value 3 (source: 180)"},
            },
            constraints: ["v1 != 31 or v2 != 30 or v3 != 180"],
            derived: {
            },
            substitutions: {
              q: {"31": "str(v1)", "30": "str(v2)", "180": "str(v3)"},
              a: {"31": "str(v1)", "30": "str(v2)", "180": "str(v3)"},
            },
            sourceValues: {"v1": 31, "v2": 30, "v3": 180},
          }
        },
            {
              qid: "FD_042_m05",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": 1.55, "max": 2.55, "step": 0.05, "description": "Value 1 (source: 2.05)"},
              v2: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 2 (source: 2)"},
            },
            constraints: ["v1 != 2.05 or v2 != 2"],
            derived: {
            },
            substitutions: {
              q: {"2.05": "str(v1)", "2": "str(v2)"},
              a: {"2.05": "str(v1)", "2": "str(v2)"},
            },
            sourceValues: {"v1": 2.05, "v2": 2},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 1 (source: 5)"},
              v2: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 2 (source: 2)"},
              v3: {"type": "float", "min": 1.54, "max": 2.54, "step": 0.05, "description": "Value 3 (source: 2.04)"},
            },
            constraints: ["v1 != 5 or v2 != 2 or v3 != 2.04"],
            derived: {
            },
            substitutions: {
              q: {"5": "str(v1)", "2": "str(v2)", "2.04": "str(v3)"},
              a: {"5": "str(v1)", "2": "str(v2)", "2.04": "str(v3)"},
            },
            sourceValues: {"v1": 5, "v2": 2, "v3": 2.04},
          }
        },
            {
              qid: "FD_042_h03",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 50, "max": 150, "step": 5, "description": "Value 1 (source: 100)"},
              v2: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 2 (source: 5)"},
              v3: {"type": "float", "min": 5.0, "max": 6.0, "step": 0.05, "description": "Value 3 (source: 5.5)"},
            },
            constraints: ["v1 != 100 or v2 != 5 or v3 != 5.5"],
            derived: {
            },
            substitutions: {
              q: {"100": "str(v1)", "5": "str(v2)", "5.5": "str(v3)"},
              a: {"100": "str(v1)", "5": "str(v2)", "5.5": "str(v3)"},
            },
            sourceValues: {"v1": 100, "v2": 5, "v3": 5.5},
          }
        },
            {
              qid: "FD_042_h05",
...
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 60 or v2 != 5"],
            derived: {
            },
            substitutions: {
              q: {"60": "str(v1)", "5": "str(v2)"},
              a: {"60": "str(v1)", "5": "str(v2)"},
            },
            sourceValues: {"v1": 60, "v2": 5},
          }
        },
            {
              qid: "FD_043_e02",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 20, "max": 60, "step": 5, "description": "Value 1 (source: 40)"},
              v2: {"type": "int", "min": 5, "max": 15, "step": 1, "description": "Value 2 (source: 10)"},
              v3: {"type": "float", "min": 40.3, "max": 41.3, "step": 0.05, "description": "Value 3 (source: 40.8)"},
            },
            constraints: ["v1 != 40 or v2 != 10 or v3 != 40.8"],
            derived: {
            },
            substitutions: {
              q: {"40": "str(v1)", "10": "str(v2)", "40.8": "str(v3)"},
              a: {"40": "str(v1)", "10": "str(v2)", "40.8": "str(v3)"},
            },
            sourceValues: {"v1": 40, "v2": 10, "v3": 40.8},
          }
        },
            {
              qid: "FD_043_e03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 100 or v2 != 10 or v3 != 2"],
            derived: {
            },
            substitutions: {
              q: {"100": "str(v1)", "10": "str(v2)", "2": "str(v3)"},
              a: {"100": "str(v1)", "10": "str(v2)", "2": "str(v3)"},
            },
            sourceValues: {"v1": 100, "v2": 10, "v3": 2},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 200 or v2 != 5"],
            derived: {
            },
            substitutions: {
              q: {"200": "str(v1)", "5": "str(v2)"},
              a: {"200": "str(v1)", "5": "str(v2)"},
            },
            sourceValues: {"v1": 200, "v2": 5},
          }
        },
            {
              qid: "FD_043_m02",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v2: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 2 (source: 4)"},
              v3: {"type": "float", "min": 3.55, "max": 4.55, "step": 0.05, "description": "Value 3 (source: 4.05)"},
            },
            constraints: ["v1 != 12 or v2 != 4 or v3 != 4.05"],
            derived: {
            },
            substitutions: {
              q: {"12": "str(v1)", "4": "str(v2)", "4.05": "str(v3)"},
              a: {"12": "str(v1)", "4": "str(v2)", "4.05": "str(v3)"},
            },
            sourceValues: {"v1": 12, "v2": 4, "v3": 4.05},
          }
        },
            {
              qid: "FD_043_m03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 48 or v2 != 6"],
            derived: {
            },
            substitutions: {
              q: {"48": "str(v1)", "6": "str(v2)"},
              a: {"48": "str(v1)", "6": "str(v2)"},
            },
            sourceValues: {"v1": 48, "v2": 6},
          }
        },
            {
              qid: "FD_043_m04",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 2000, "max": 6000, "step": 5, "description": "Value 1 (source: 4000)"},
              v2: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 2 (source: 3)"},
              v3: {"type": "int", "min": 5, "max": 15, "step": 1, "description": "Value 3 (source: 10)"},
            },
            constraints: ["v1 != 4000 or v2 != 3 or v3 != 10"],
            derived: {
            },
            substitutions: {
              q: {"4000": "str(v1)", "3": "str(v2)", "10": "str(v3)"},
              a: {"4000": "str(v1)", "3": "str(v2)", "10": "str(v3)"},
            },
            sourceValues: {"v1": 4000, "v2": 3, "v3": 10},
          }
        },
            {
              qid: "FD_043_m05",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 500 or v2 != 10 or v3 != 5"],
            derived: {
            },
            substitutions: {
              q: {"500": "str(v1)", "10": "str(v2)", "5": "str(v3)"},
              a: {"500": "str(v1)", "10": "str(v2)", "5": "str(v3)"},
            },
            sourceValues: {"v1": 500, "v2": 10, "v3": 5},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 65, "max": 195, "step": 5, "description": "Value 1 (source: 130)"},
              v2: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 2 (source: 5)"},
            },
            constraints: ["v1 != 130 or v2 != 5"],
            derived: {
            },
            substitutions: {
              q: {"130": "str(v1)", "5": "str(v2)"},
              a: {"130": "str(v1)", "5": "str(v2)"},
            },
            sourceValues: {"v1": 130, "v2": 5},
          }
        },
            {
              qid: "FD_043_h02",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 7, "max": 19, "step": 1, "description": "Value 1 (source: 13)"},
              v2: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 2 (source: 5)"},
              v3: {"type": "int", "min": 6, "max": 18, "step": 1, "description": "Value 3 (source: 12)"},
            },
            constraints: ["v1 != 13 or v2 != 5 or v3 != 12"],
            derived: {
            },
            substitutions: {
              q: {"13": "str(v1)", "5": "str(v2)", "12": "str(v3)"},
              a: {"13": "str(v1)", "5": "str(v2)", "12": "str(v3)"},
            },
            sourceValues: {"v1": 13, "v2": 5, "v3": 12},
          }
        },
            {
              qid: "FD_043_h03",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 400, "max": 1200, "step": 5, "description": "Value 1 (source: 800)"},
              v2: {"type": "int", "min": 20, "max": 60, "step": 5, "description": "Value 2 (source: 40)"},
            },
            constraints: ["v1 != 800 or v2 != 40"],
            derived: {
            },
            substitutions: {
              q: {"800": "str(v1)", "40": "str(v2)"},
              a: {"800": "str(v1)", "40": "str(v2)"},
            },
            sourceValues: {"v1": 800, "v2": 40},
          }
        },
            {
              qid: "FD_043_h04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 40 or v2 != 8 or v3 != 12"],
            derived: {
            },
            substitutions: {
              q: {"40": "str(v1)", "8": "str(v2)", "12": "str(v3)", "2": "str(v4)"},
              a: {"40": "str(v1)", "8": "str(v2)", "12": "str(v3)", "2": "str(v4)"},
            },
            sourceValues: {"v1": 40, "v2": 8, "v3": 12, "v4": 2},
          }
        },
            {
              qid: "FD_043_h05",
...
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 50 or v2 != 10"],
            derived: {
            },
            substitutions: {
              q: {"50": "str(v1)", "10": "str(v2)"},
              a: {"50": "str(v1)", "10": "str(v2)"},
            },
            sourceValues: {"v1": 50, "v2": 10},
          }
        },
            {
              qid: "FD_044_m02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 4 or v2 != 20"],
            derived: {
            },
            substitutions: {
              q: {"4": "str(v1)", "20": "str(v2)"},
              a: {"4": "str(v1)", "20": "str(v2)"},
            },
            sourceValues: {"v1": 4, "v2": 20},
          }
        },
            {
              qid: "FD_044_m03",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 12, "max": 36, "step": 5, "description": "Value 1 (source: 24)"},
              v2: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 2 (source: 5)"},
            },
            constraints: ["v1 != 24 or v2 != 5"],
            derived: {
            },
            substitutions: {
              q: {"24": "str(v1)", "5": "str(v2)"},
              a: {"24": "str(v1)", "5": "str(v2)"},
            },
            sourceValues: {"v1": 24, "v2": 5},
          }
        },
            {
              qid: "FD_044_m05",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 30 or v2 != 6 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"30": "str(v1)", "6": "str(v2)", "4": "str(v3)"},
              a: {"30": "str(v1)", "6": "str(v2)", "4": "str(v3)"},
            },
            sourceValues: {"v1": 30, "v2": 6, "v3": 4},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 12 or v2 != 4 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"12": "str(v1)", "4": "str(v2)", "3": "str(v3)", "6": "str(v4)"},
              a: {"12": "str(v1)", "4": "str(v2)", "3": "str(v3)", "6": "str(v4)"},
            },
            sourceValues: {"v1": 12, "v2": 4, "v3": 3, "v4": 6},
          }
        },
            {
              qid: "FD_044_h03",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 1 (source: 2)"},
              v2: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Value 2 (source: 6)"},
              v3: {"type": "float", "min": 1.0, "max": 2.0, "step": 0.05, "description": "Value 3 (source: 1.5)"},
            },
            constraints: ["v1 != 2 or v2 != 6 or v3 != 1.5"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "6": "str(v2)", "1.5": "str(v3)"},
              a: {"2": "str(v1)", "6": "str(v2)", "1.5": "str(v3)"},
            },
            sourceValues: {"v1": 2, "v2": 6, "v3": 1.5},
          }
        },
            {
              qid: "FD_044_h04",
...
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 2*x - 4. At x=2: gradient=0.0, y=-1.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Constant term"},
            ...
            sourceValues: {"c0": 1, "c1": -4, "c2": 3, "x_val": 2},
          }
        },
            {
              qid: "FD_045_e03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*x**2 - 6*x + 3. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -8, "max": 2, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -3 or c2 != 3"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 1, "c1": -3, "c2": 3, "c3": 1},
          }
        },
            {
              qid: "FD_045_m02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 3*(x - 1)**2. At x=1: gradient=0.0, y=2.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": -8, "max": 2, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Coefficient of x^1"},
            ...
            sourceValues: {"c0": 1, "c1": -3, "c2": 3, "c3": 1, "x_val": 1},
          }
        },
            {
              qid: "FD_045_m05",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 15*x**4 - 15*x**2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Coefficient of x^5"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^4"},
              c2: {"type": "int", "min": -10, "max": 0, "step": 1, "description": "Coefficient of x^3"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c4: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c5: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 3 or c1 != 0 or c2 != -5"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 3, "c1": 0, "c2": -5, "c3": 0, "c4": 0, "c5": 0},
          }
        },
            {
              qid: "FD_045_h02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4*x**3 - 12*x**2 + 12*x - 4. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 1 or c1 != -4 or c2 != 6"],
            derived: {
            ...
            sourceValues: {"c0": 1, "c1": -4, "c2": 6, "c3": -4, "c4": 1},
          }
        },
            {
              qid: "FD_045_h05",
...
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 4*x**3. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": 0, "c3": 0, "c4": 0, "x_val": 0},
          }
        },
            {
              qid: "FD_046_e02",
          ...
          seedSpec: {
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": 0, "c3": 0, "x_val": 0},
          }
        },
            {
              qid: "FD_046_e03",
          ...
          seedSpec: {
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": -6, "c3": 8, "c4": 1},
          }
        },
            {
              qid: "FD_046_m02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 6*x**5. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^6"},
              c1: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^5"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^4"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^3"},
              c4: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c5: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c6: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": -3, "max": 3, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != 1 or c1 != 0 or c2 != 0"],
            derived: {
            ...
            sourceValues: {"c0": 1, "c1": 0, "c2": 0, "c3": 0, "c4": 0, "c5": 0, "c6": 0, "x_val": 0},
          }
        },
            {
              qid: "FD_046_m03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 15*x**4 - 20*x**3. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Coefficient of x^5"},
              c1: {"type": "int", "min": -10, "max": 0, "step": 1, "description": "Coefficient of x^4"},
              c2: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^3"},
              c3: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^2"},
              c4: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Coefficient of x^1"},
              c5: {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 3 or c1 != -5 or c2 != 0"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 3, "c1": -5, "c2": 0, "c3": 0, "c4": 0, "c5": 0},
          }
        },
            {
              qid: "FD_046_m04",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 5*x**4 - 20*x**3 + 30*x**2 - 20*x + 5. At x=1: gradient=0.0, y=0.0. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Coefficient of x^5"},
              c1: {"type": "int", "min": -10, "max": 0, "step": 1, "description": "Coefficient of x^4"},
              c2: {"type": "int", "min": 5, "max": 15, "step": 1, "description": "Coefficient of x^3"},
              c3: {"type": "int", "min": -15, "max": -5, "step": 1, "description": "Coefficient of x^2"},
              c4: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Coefficient of x^1"},
              c5: {"type": "int", "min": -6, "max": 4, "step": 1, "description": "Constant term"},
              x_val: {"type": "int", "min": -2, "max": 4, "step": 1, "description": "x-value to evaluate at"},
            },
            constraints: ["c0 != 1 or c1 != -5 or c2 != 10"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
              grad_at_x: {"expr": "float(deriv.subs(x, x_val))", "note": "Gradient at x_val"},
              y_at_x: {"expr": "float(expr.subs(x, x_val))", "note": "y-value at x_val"},
            ...
            sourceValues: {"c0": 1, "c1": -5, "c2": 10, "c3": -10, "c4": 5, "c5": -1, "x_val": 1},
          }
        },
            {
              qid: "FD_046_h04",
...
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 15*(3*x + 1)**4. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": 238, "max": 248, "step": 1, "description": "Coefficient of x^5"},
              c1: {"type": "int", "min": 400, "max": 410, "step": 1, "description": "Coefficient of x^4"},
              c2: {"type": "int", "min": 265, "max": 275, "step": 1, "description": "Coefficient of x^3"},
              c3: {"type": "int", "min": 85, "max": 95, "step": 1, "description": "Coefficient of x^2"},
              c4: {"type": "int", "min": 10, "max": 20, "step": 1, "description": "Coefficient of x^1"},
              c5: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 243 or c1 != 405 or c2 != 270"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 243, "c1": 405, "c2": 270, "c3": 90, "c4": 15, "c5": 1},
          }
        },
            {
              qid: "XX_003_e02",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 8*(2*x - 3)**3. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": 11, "max": 21, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -101, "max": -91, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": 211, "max": 221, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": -221, "max": -211, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": 76, "max": 86, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 16 or c1 != -96 or c2 != 216"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 16, "c1": -96, "c2": 216, "c3": -216, "c4": 81},
          }
        },
            {
              qid: "XX_003_e03",
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = -3*(5 - x)**2. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -6, "max": 4, "step": 1, "description": "Coefficient of x^3"},
              c1: {"type": "int", "min": 10, "max": 20, "step": 1, "description": "Coefficient of x^2"},
              c2: {"type": "int", "min": -80, "max": -70, "step": 1, "description": "Coefficient of x^1"},
              c3: {"type": "int", "min": 120, "max": 130, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != -1 or c1 != 15 or c2 != -75"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": -1, "c1": 15, "c2": -75, "c3": 125},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = (24*x - 8)*(3*x**2 - 2*x + 1)**3. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": 76, "max": 86, "step": 1, "description": "Coefficient of x^8"},
              c1: {"type": "int", "min": -221, "max": -211, "step": 1, "description": "Coefficient of x^7"},
              c2: {"type": "int", "min": 319, "max": 329, "step": 1, "description": "Coefficient of x^6"},
              c3: {"type": "int", "min": -317, "max": -307, "step": 1, "description": "Coefficient of x^5"},
              c4: {"type": "int", "min": 209, "max": 219, "step": 1, "description": "Coefficient of x^4"},
              c5: {"type": "int", "min": -109, "max": -99, "step": 1, "description": "Coefficient of x^3"},
              c6: {"type": "int", "min": 31, "max": 41, "step": 1, "description": "Coefficient of x^2"},
              c7: {"type": "int", "min": -13, "max": -3, "step": 1, "description": "Coefficient of x^1"},
              c8: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 81 or c1 != -216 or c2 != 324"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 81, "c1": -216, "c2": 324, "c3": -312, "c4": 214, "c5": -104, "c6": 36, "c7": -8, "c8": 1},
          }
        },
            {
              qid: "XX_003_m04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 8 or v2 != 2 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"8": "str(v1)", "2": "str(v2)", "3": "str(v3)"},
              a: {"8": "str(v1)", "2": "str(v2)", "3": "str(v3)"},
            },
            sourceValues: {"v1": 8, "v2": 2, "v3": 3},
          }
        },
            {
              qid: "XX_003_h04",
...
,

    {
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"3": "str(v1)", "4": "str(v2)", "2": "str(v3)", "5": "str(v4)", "-2": "str(v5)", "6": "str(v6)"},
              a: {"3": "str(v1)", "4": "str(v2)", "2": "str(v3)", "5": "str(v4)", "-2": "str(v5)", "6": "str(v6)"},
            },
            sourceValues: {"v1": 3, "v2": 4, "v3": 2, "v4": 5, "v5": -2, "v6": 6},
          }
        },
            {
              qid: "XX_004_e02",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v4: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 4 (source: 5)"},
              v5: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 5 (source: 2)"},
              v6: {"type": "int", "min": 2, "max": 12, "step": 1, "description": "Value 6 (source: 7)"},
            },
            constraints: ["v1 != 4 or v2 != -3 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"4": "str(v1)", "-3": "str(v2)", "3": "str(v3)", "5": "str(v4)", "2": "str(v5)", "7": "str(v6)"},
              a: {"4": "str(v1)", "-3": "str(v2)", "3": "str(v3)", "5": "str(v4)", "2": "str(v5)", "7": "str(v6)"},
            },
            sourceValues: {"v1": 4, "v2": -3, "v3": 3, "v4": 5, "v5": 2, "v6": 7},
          }
        },
            {
              qid: "XX_004_m02",
...
,

    {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 8*x - 12. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Coefficient of x^2"},
              c1: {"type": "int", "min": -17, "max": -7, "step": 1, "description": "Coefficient of x^1"},
              c2: {"type": "int", "min": 4, "max": 14, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 4 or c1 != -12 or c2 != 9"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
          ...
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Polynomial differentiation. f'(x) = 12*(3*x - 1)**3. Verified by SymPy diff().",
            parameters: {
              c0: {"type": "int", "min": 76, "max": 86, "step": 1, "description": "Coefficient of x^4"},
              c1: {"type": "int", "min": -113, "max": -103, "step": 1, "description": "Coefficient of x^3"},
              c2: {"type": "int", "min": 49, "max": 59, "step": 1, "description": "Coefficient of x^2"},
              c3: {"type": "int", "min": -17, "max": -7, "step": 1, "description": "Coefficient of x^1"},
              c4: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Constant term"},
            },
            constraints: ["c0 != 81 or c1 != -108 or c2 != 54"],
            derived: {
              deriv_str: {"expr": "sympy.diff(polynomial_expr, x)", "note": "Symbolic derivative"},
            },
            substitutions: {
            ...
            sourceValues: {"c0": 81, "c1": -108, "c2": 54, "c3": -12, "c4": 1},
          }
        },
            {
              qid: "XX_006_h04",
...
,

    {
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"3": "str(v1)", "2": "str(v2)", "-2": "str(v3)"},
              a: {"3": "str(v1)", "2": "str(v2)", "-2": "str(v3)"},
            },
            sourceValues: {"v1": 3, "v2": 2, "v3": -2},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"3": "str(v1)", "-2": "str(v2)", "4": "str(v3)", "5": "str(v4)"},
              a: {"3": "str(v1)", "-2": "str(v2)", "4": "str(v3)", "5": "str(v4)"},
            },
            sourceValues: {"v1": 3, "v2": -2, "v3": 4, "v4": 5},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v3: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 3 (source: 3)"},
              v4: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 4 (source: 4)"},
              v5: {"type": "int", "min": -9, "max": 1, "step": 1, "description": "Value 5 (source: -4)"},
            },
            constraints: ["v1 != 2 or v2 != 6 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "6": "str(v2)", "3": "str(v3)", "4": "str(v4)", "-4": "str(v5)"},
              a: {"2": "str(v1)", "6": "str(v2)", "3": "str(v3)", "4": "str(v4)", "-4": "str(v5)"},
            },
            sourceValues: {"v1": 2, "v2": 6, "v3": 3, "v4": 4, "v5": -4},
          }
        },
            {
              qid: "XX_008_m03",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v2: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 2 (source: 2)"},
              v3: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 3 (source: 5)"},
              v4: {"type": "int", "min": 7, "max": 19, "step": 1, "description": "Value 4 (source: 13)"},
            },
            constraints: ["v1 != 3 or v2 != 2 or v3 != 5"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "2": "str(v2)", "5": "str(v3)", "13": "str(v4)"},
              a: {"3": "str(v1)", "2": "str(v2)", "5": "str(v3)", "13": "str(v4)"},
            },
            sourceValues: {"v1": 3, "v2": 2, "v3": 5, "v4": 13},
          }
        },
            {
              qid: "XX_008_m05",
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"2": "str(v1)", "6": "str(v2)", "-3": "str(v3)", "4": "str(v4)"},
              a: {"2": "str(v1)", "6": "str(v2)", "-3": "str(v3)", "4": "str(v4)"},
            },
            sourceValues: {"v1": 2, "v2": 6, "v3": -3, "v4": 4},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"3": "str(v1)", "4": "str(v2)", "2": "str(v3)", "5": "str(v4)", "-2": "str(v5)"},
              a: {"3": "str(v1)", "4": "str(v2)", "2": "str(v3)", "5": "str(v4)", "-2": "str(v5)"},
            },
            sourceValues: {"v1": 3, "v2": 4, "v3": 2, "v4": 5, "v5": -2},
          }
        },
            {
              qid: "XX_008_h02",
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"2": "str(v1)", "-3": "str(v2)", "4": "str(v3)", "5": "str(v4)", "-2": "str(v5)"},
              a: {"2": "str(v1)", "-3": "str(v2)", "4": "str(v3)", "5": "str(v4)", "-2": "str(v5)"},
            },
            sourceValues: {"v1": 2, "v2": -3, "v3": 4, "v4": 5, "v5": -2},
          }
        },
            {
              qid: "XX_008_h04",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v4: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Value 4 (source: -2)"},
              v5: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 5 (source: 3)"},
              v6: {"type": "int", "min": -10, "max": 0, "step": 1, "description": "Value 6 (source: -5)"},
            },
            constraints: ["v1 != 2 or v2 != -3 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "-3": "str(v2)", "4": "str(v3)", "-2": "str(v4)", "3": "str(v5)", "-5": "str(v6)"},
              a: {"2": "str(v1)", "-3": "str(v2)", "4": "str(v3)", "-2": "str(v4)", "3": "str(v5)", "-5": "str(v6)"},
            },
            sourceValues: {"v1": 2, "v2": -3, "v3": 4, "v4": -2, "v5": 3, "v6": -5},
          }
        }
          ]
        }
...

{
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 1 (source: 5)"},
              v2: {"type": "int", "min": 1000, "max": 3000, "step": 5, "description": "Value 2 (source: 2000)"},
              v3: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 3 (source: 3)"},
              v4: {"type": "int", "min": 2, "max": 12, "step": 1, "description": "Value 4 (source: 7)"},
            },
            constraints: ["v1 != 5 or v2 != 2000 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"5": "str(v1)", "2000": "str(v2)", "3": "str(v3)", "7": "str(v4)"},
              a: {"5": "str(v1)", "2000": "str(v2)", "3": "str(v3)", "7": "str(v4)"},
            },
            sourceValues: {"v1": 5, "v2": 2000, "v3": 3, "v4": 7},
          }
        },
            {
              qid: "FD_NEW_04_e02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 500 or v2 != 2 or v3 != 10"],
            derived: {
            },
            substitutions: {
              q: {"500": "str(v1)", "2": "str(v2)", "10": "str(v3)"},
              a: {"500": "str(v1)", "2": "str(v2)", "10": "str(v3)"},
            },
            sourceValues: {"v1": 500, "v2": 2, "v3": 10},
          }
        },
            {
              qid: "FD_NEW_04_e03",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 6000, "max": 18000, "step": 5, "description": "Value 1 (source: 12000)"},
              v2: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 2 (source: 3)"},
              v3: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Value 3 (source: 6)"},
              v4: {"type": "int", "min": 4, "max": 14, "step": 1, "description": "Value 4 (source: 9)"},
            },
            constraints: ["v1 != 12000 or v2 != 3 or v3 != 6"],
            derived: {
            },
            substitutions: {
              q: {"12000": "str(v1)", "3": "str(v2)", "6": "str(v3)", "9": "str(v4)"},
              a: {"12000": "str(v1)", "3": "str(v2)", "6": "str(v3)", "9": "str(v4)"},
            },
            sourceValues: {"v1": 12000, "v2": 3, "v3": 6, "v4": 9},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 25, "max": 75, "step": 5, "description": "Value 1 (source: 50)"},
              v2: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 2 (source: 5)"},
              v3: {"type": "int", "min": 10, "max": 30, "step": 5, "description": "Value 3 (source: 20)"},
            },
            constraints: ["v1 != 50 or v2 != 5 or v3 != 20"],
            derived: {
            },
            substitutions: {
              q: {"50": "str(v1)", "5": "str(v2)", "20": "str(v3)"},
              a: {"50": "str(v1)", "5": "str(v2)", "20": "str(v3)"},
            },
            sourceValues: {"v1": 50, "v2": 5, "v3": 20},
          }
        },
            {
              qid: "FD_NEW_04_m02",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 1 (source: 4)"},
              v2: {"type": "int", "min": 4, "max": 14, "step": 1, "description": "Value 2 (source: 9)"},
              v3: {"type": "float", "min": 2.0, "max": 3.0, "step": 0.05, "description": "Value 3 (source: 2.5)"},
            },
            constraints: ["v1 != 4 or v2 != 9 or v3 != 2.5"],
            derived: {
            },
            substitutions: {
              q: {"4": "str(v1)", "9": "str(v2)", "2.5": "str(v3)"},
              a: {"4": "str(v1)", "9": "str(v2)", "2.5": "str(v3)"},
            },
            sourceValues: {"v1": 4, "v2": 9, "v3": 2.5},
          }
        },
            {
              qid: "FD_NEW_04_m03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 80 or v2 != 4"],
            derived: {
            },
            substitutions: {
              q: {"80": "str(v1)", "4": "str(v2)"},
              a: {"80": "str(v1)", "4": "str(v2)"},
            },
            sourceValues: {"v1": 80, "v2": 4},
          }
        },
            {
              qid: "FD_NEW_04_m04",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 129, "max": 385, "step": 5, "description": "Value 1 (source: 257)"},
              v2: {"type": "float", "min": 100.0, "max": 101.0, "step": 0.05, "description": "Value 2 (source: 100.5)"},
              v3: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 3 (source: 3)"},
              v4: {"type": "int", "min": 50, "max": 150, "step": 5, "description": "Value 4 (source: 100)"},
              v5: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 5 (source: 5)"},
            },
            constraints: ["v1 != 257 or v2 != 100.5 or v3 != 3"],
            derived: {
            },
            substitutions: {
              q: {"257": "str(v1)", "100.5": "str(v2)", "3": "str(v3)", "100": "str(v4)", "5": "str(v5)"},
              a: {"257": "str(v1)", "100.5": "str(v2)", "3": "str(v3)", "100": "str(v4)", "5": "str(v5)"},
            },
            sourceValues: {"v1": 257, "v2": 100.5, "v3": 3, "v4": 100, "v5": 5},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 113, "max": 339, "step": 5, "description": "Value 1 (source: 226)"},
              v2: {"type": "int", "min": 800, "max": 2400, "step": 5, "description": "Value 2 (source: 1600)"},
              v3: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Value 3 (source: 6)"},
            },
            constraints: ["v1 != 226 or v2 != 1600 or v3 != 6"],
            derived: {
            },
            substitutions: {
              q: {"226": "str(v1)", "1600": "str(v2)", "6": "str(v3)"},
              a: {"226": "str(v1)", "1600": "str(v2)", "6": "str(v3)"},
            },
            sourceValues: {"v1": 226, "v2": 1600, "v3": 6},
          }
        },
            {
              qid: "FD_017_m03",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 66, "max": 196, "step": 5, "description": "Value 1 (source: 131)"},
              v2: {"type": "int", "min": 3, "max": 13, "step": 1, "description": "Value 2 (source: 8)"},
            },
            constraints: ["v1 != 131 or v2 != 8"],
            derived: {
            },
            substitutions: {
              q: {"131": "str(v1)", "8": "str(v2)"},
              a: {"131": "str(v1)", "8": "str(v2)"},
            },
            sourceValues: {"v1": 131, "v2": 8},
          }
        },
            {
              qid: "FD_017_m04",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 7, "max": 21, "step": 1, "description": "Value 1 (source: 14)"},
              v2: {"type": "int", "min": 2865, "max": 8595, "step": 5, "description": "Value 2 (source: 5730)"},
              v3: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Value 3 (source: 6)"},
            },
            constraints: ["v1 != 14 or v2 != 5730 or v3 != 6"],
            derived: {
            },
            substitutions: {
              q: {"14": "str(v1)", "5730": "str(v2)", "6": "str(v3)"},
              a: {"14": "str(v1)", "5730": "str(v2)", "6": "str(v3)"},
            },
            sourceValues: {"v1": 14, "v2": 5730, "v3": 6},
          }
        },
            {
              qid: "FD_017_m05",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": 2.0, "max": 3.0, "step": 0.05, "description": "Value 1 (source: 2.5)"},
            },
            constraints: ["v1 != 2.5"],
            derived: {
            },
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 25 or v2 != 30"],
            derived: {
            },
            substitutions: {
              q: {"25": "str(v1)", "30": "str(v2)"},
              a: {"25": "str(v1)", "30": "str(v2)"},
            },
            sourceValues: {"v1": 25, "v2": 30},
          }
        },
            {
              qid: "FD_017_h02",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 1 (source: 2)"},
              v2: {"type": "int", "min": 400, "max": 1200, "step": 5, "description": "Value 2 (source: 800)"},
              v3: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Value 3 (source: 6)"},
              v4: {"type": "int", "min": 250, "max": 750, "step": 5, "description": "Value 4 (source: 500)"},
            },
            constraints: ["v1 != 2 or v2 != 800 or v3 != 6"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "800": "str(v2)", "6": "str(v3)", "500": "str(v4)"},
              a: {"2": "str(v1)", "800": "str(v2)", "6": "str(v3)", "500": "str(v4)"},
            },
            sourceValues: {"v1": 2, "v2": 800, "v3": 6, "v4": 500},
          }
        },
            {
              qid: "FD_017_h04",
...
,

    {
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": -0.6, "max": 0.4, "step": 0.05, "description": "Value 1 (source: -0.1)"},
            },
            constraints: ["v1 != -0.1"],
            derived: {
            },
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": -0.7, "max": 0.3, "step": 0.05, "description": "Value 1 (source: -0.2)"},
            },
            constraints: ["v1 != -0.2"],
            derived: {
            },
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": -0.44, "max": 0.56, "step": 0.05, "description": "Value 1 (source: 0.06)"},
            },
            constraints: ["v1 != 0.06"],
            derived: {
            },
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": -0.42, "max": 0.58, "step": 0.05, "description": "Value 1 (source: 0.08)"},
            },
            constraints: ["v1 != 0.08"],
            derived: {
            },
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": -0.51, "max": 0.49, "step": 0.05, "description": "Value 1 (source: -0.01)"},
              v2: {"type": "int", "min": -4, "max": 6, "step": 1, "description": "Value 2 (source: 1)"},
            },
            constraints: ["v1 != -0.01 or v2 != 1"],
            derived: {
            },
            substitutions: {
              q: {"-0.01": "str(v1)", "1": "str(v2)"},
              a: {"-0.01": "str(v1)", "1": "str(v2)"},
            },
            sourceValues: {"v1": -0.01, "v2": 1},
          }
        },
            {
              qid: "FD_018_h02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 15 or v2 != 80"],
            derived: {
            },
            substitutions: {
              q: {"15": "str(v1)", "80": "str(v2)"},
              a: {"15": "str(v1)", "80": "str(v2)"},
            },
            sourceValues: {"v1": 15, "v2": 80},
          }
        },
            {
              qid: "FD_018_h03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 5 or v2 != 10"],
            derived: {
            },
            substitutions: {
              q: {"5": "str(v1)", "10": "str(v2)"},
              a: {"5": "str(v1)", "10": "str(v2)"},
            },
            sourceValues: {"v1": 5, "v2": 10},
          }
        },
            {
              qid: "FD_018_h04",
...

    {
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 1 (source: 3)"},
              v2: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 2 (source: 5)"},
              v3: {"type": "int", "min": 1000, "max": 3000, "step": 5, "description": "Value 3 (source: 2000)"},
            },
            constraints: ["v1 != 3 or v2 != 5 or v3 != 2000"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "5": "str(v2)", "2000": "str(v3)"},
              a: {"3": "str(v1)", "5": "str(v2)", "2000": "str(v3)"},
            },
            sourceValues: {"v1": 3, "v2": 5, "v3": 2000},
          }
        },
            {
              qid: "FD_019_e02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 500 or v2 != 4"],
            derived: {
            },
            substitutions: {
              q: {"500": "str(v1)", "4": "str(v2)"},
              a: {"500": "str(v1)", "4": "str(v2)"},
            },
            sourceValues: {"v1": 500, "v2": 4},
          }
        },
            {
              qid: "FD_019_e03",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 750, "max": 2250, "step": 5, "description": "Value 1 (source: 1500)"},
              v2: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 2 (source: 2)"},
            },
            constraints: ["v1 != 1500 or v2 != 2"],
            derived: {
            },
            substitutions: {
              q: {"1500": "str(v1)", "2": "str(v2)"},
              a: {"1500": "str(v1)", "2": "str(v2)"},
            },
            sourceValues: {"v1": 1500, "v2": 2},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 6 or v2 != 15 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"6": "str(v1)", "15": "str(v2)", "4": "str(v3)"},
              a: {"6": "str(v1)", "15": "str(v2)", "4": "str(v3)"},
            },
            sourceValues: {"v1": 6, "v2": 15, "v3": 4},
          }
        },
            {
              qid: "FD_019_m02",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 3, "max": 13, "step": 1, "description": "Value 1 (source: 8)"},
              v2: {"type": "int", "min": 60, "max": 180, "step": 5, "description": "Value 2 (source: 120)"},
            },
            constraints: ["v1 != 8 or v2 != 120"],
            derived: {
            },
            substitutions: {
              q: {"8": "str(v1)", "120": "str(v2)"},
              a: {"8": "str(v1)", "120": "str(v2)"},
            },
            sourceValues: {"v1": 8, "v2": 120},
          }
        },
            {
              qid: "FD_019_m03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 800 or v2 != 5"],
            derived: {
            },
            substitutions: {
              q: {"800": "str(v1)", "5": "str(v2)"},
              a: {"800": "str(v1)", "5": "str(v2)"},
            },
            sourceValues: {"v1": 800, "v2": 5},
          }
        },
            {
              qid: "FD_019_m04",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 13, "max": 37, "step": 5, "description": "Value 1 (source: 25)"},
              v2: {"type": "int", "min": 6, "max": 18, "step": 1, "description": "Value 2 (source: 12)"},
              v3: {"type": "float", "min": 4.0, "max": 5.0, "step": 0.05, "description": "Value 3 (source: 4.5)"},
            },
            constraints: ["v1 != 25 or v2 != 12 or v3 != 4.5"],
            derived: {
            },
            substitutions: {
              q: {"25": "str(v1)", "12": "str(v2)", "4.5": "str(v3)"},
              a: {"25": "str(v1)", "12": "str(v2)", "4.5": "str(v3)"},
            },
            sourceValues: {"v1": 25, "v2": 12, "v3": 4.5},
          }
        },
            {
              qid: "FD_019_m05",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 200 or v2 != 15"],
            derived: {
            },
            substitutions: {
              q: {"200": "str(v1)", "15": "str(v2)"},
              a: {"200": "str(v1)", "15": "str(v2)"},
            },
            sourceValues: {"v1": 200, "v2": 15},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v3: {"type": "int", "min": 75, "max": 225, "step": 5, "description": "Value 3 (source: 150)"},
            },
            constraints: ["v1 != 10 or v2 != 25 or v3 != 150"],
            derived: {
            },
            substitutions: {
              q: {"10": "str(v1)", "25": "str(v2)", "150": "str(v3)"},
              a: {"10": "str(v1)", "25": "str(v2)", "150": "str(v3)"},
            },
            sourceValues: {"v1": 10, "v2": 25, "v3": 150},
          }
        },
            {
              qid: "FD_019_h02",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 37, "max": 109, "step": 5, "description": "Value 1 (source: 73)"},
              v2: {"type": "int", "min": 7, "max": 21, "step": 1, "description": "Value 2 (source: 14)"},
              v3: {"type": "int", "min": 2865, "max": 8595, "step": 5, "description": "Value 3 (source: 5730)"},
            },
            constraints: ["v1 != 73 or v2 != 14 or v3 != 5730"],
            derived: {
            },
            substitutions: {
              q: {"73": "str(v1)", "14": "str(v2)", "5730": "str(v3)"},
              a: {"73": "str(v1)", "14": "str(v2)", "5730": "str(v3)"},
            },
            sourceValues: {"v1": 73, "v2": 14, "v3": 5730},
          }
        },
            {
              qid: "FD_019_h03",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 1 (source: 3)"},
              v2: {"type": "int", "min": 300, "max": 900, "step": 5, "description": "Value 2 (source: 600)"},
              v3: {"type": "int", "min": 2, "max": 12, "step": 1, "description": "Value 3 (source: 7)"},
              v4: {"type": "int", "min": 175, "max": 525, "step": 5, "description": "Value 4 (source: 350)"},
            },
            constraints: ["v1 != 3 or v2 != 600 or v3 != 7"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "600": "str(v2)", "7": "str(v3)", "350": "str(v4)"},
              a: {"3": "str(v1)", "600": "str(v2)", "7": "str(v3)", "350": "str(v4)"},
            },
            sourceValues: {"v1": 3, "v2": 600, "v3": 7, "v4": 350},
          }
        },
            {
              qid: "FD_019_h04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 90 or v2 != 20 or v3 != 5"],
            derived: {
            },
            substitutions: {
              q: {"90": "str(v1)", "20": "str(v2)", "5": "str(v3)"},
              a: {"90": "str(v1)", "20": "str(v2)", "5": "str(v3)"},
            },
            sourceValues: {"v1": 90, "v2": 20, "v3": 5},
          }
        },
            {
              qid: "FD_019_h05",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 3.5 or v2 != 50 or v3 != 20"],
            derived: {
            },
            substitutions: {
              q: {"3.5": "str(v1)", "50": "str(v2)", "20": "str(v3)"},
              a: {"3.5": "str(v1)", "50": "str(v2)", "20": "str(v3)"},
            },
            sourceValues: {"v1": 3.5, "v2": 50, "v3": 20},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 100 or v2 != 3 or v3 != 200"],
            derived: {
            },
            substitutions: {
              q: {"100": "str(v1)", "3": "str(v2)", "200": "str(v3)"},
              a: {"100": "str(v1)", "3": "str(v2)", "200": "str(v3)"},
            },
            sourceValues: {"v1": 100, "v2": 3, "v3": 200},
          }
        },
            {
              qid: "FD_020_e02",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 250, "max": 750, "step": 5, "description": "Value 1 (source: 500)"},
              v2: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 2 (source: 4)"},
              v3: {"type": "int", "min": 125, "max": 375, "step": 5, "description": "Value 3 (source: 250)"},
            },
            constraints: ["v1 != 500 or v2 != 4 or v3 != 250"],
            derived: {
            },
            substitutions: {
              q: {"500": "str(v1)", "4": "str(v2)", "250": "str(v3)"},
              a: {"500": "str(v1)", "4": "str(v2)", "250": "str(v3)"},
            },
            sourceValues: {"v1": 500, "v2": 4, "v3": 250},
          }
        },
            {
              qid: "FD_020_e03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 50 or v2 != 10 or v3 != 150"],
            derived: {
            },
            substitutions: {
              q: {"50": "str(v1)", "10": "str(v2)", "150": "str(v3)"},
              a: {"50": "str(v1)", "10": "str(v2)", "150": "str(v3)"},
            },
            sourceValues: {"v1": 50, "v2": 10, "v3": 150},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 100, "max": 300, "step": 5, "description": "Value 1 (source: 200)"},
              v2: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 2 (source: 5)"},
              v3: {"type": "int", "min": 175, "max": 525, "step": 5, "description": "Value 3 (source: 350)"},
            },
            constraints: ["v1 != 200 or v2 != 5 or v3 != 350"],
            derived: {
            },
            substitutions: {
              q: {"200": "str(v1)", "5": "str(v2)", "350": "str(v3)"},
              a: {"200": "str(v1)", "5": "str(v2)", "350": "str(v3)"},
            },
            sourceValues: {"v1": 200, "v2": 5, "v3": 350},
          }
        },
            {
              qid: "FD_020_m02",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 1 (source: 2)"},
              v2: {"type": "int", "min": 200, "max": 600, "step": 5, "description": "Value 2 (source: 400)"},
              v3: {"type": "int", "min": 3, "max": 13, "step": 1, "description": "Value 3 (source: 8)"},
              v4: {"type": "int", "min": 50, "max": 150, "step": 5, "description": "Value 4 (source: 100)"},
            },
            constraints: ["v1 != 2 or v2 != 400 or v3 != 8"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "400": "str(v2)", "8": "str(v3)", "100": "str(v4)"},
              a: {"2": "str(v1)", "400": "str(v2)", "8": "str(v3)", "100": "str(v4)"},
            },
            sourceValues: {"v1": 2, "v2": 400, "v3": 8, "v4": 100},
          }
        },
            {
              qid: "FD_020_m03",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 60, "max": 180, "step": 5, "description": "Value 1 (source: 120)"},
              v2: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 2 (source: 4)"},
              v3: {"type": "int", "min": 150, "max": 450, "step": 5, "description": "Value 3 (source: 300)"},
            },
            constraints: ["v1 != 120 or v2 != 4 or v3 != 300"],
            derived: {
            },
            substitutions: {
              q: {"120": "str(v1)", "4": "str(v2)", "300": "str(v3)"},
              a: {"120": "str(v1)", "4": "str(v2)", "300": "str(v3)"},
            },
            sourceValues: {"v1": 120, "v2": 4, "v3": 300},
          }
        },
            {
              qid: "FD_020_m04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 80 or v2 != 5 or v3 != 50"],
            derived: {
            },
            substitutions: {
              q: {"80": "str(v1)", "5": "str(v2)", "50": "str(v3)"},
              a: {"80": "str(v1)", "5": "str(v2)", "50": "str(v3)"},
            },
            sourceValues: {"v1": 80, "v2": 5, "v3": 50},
          }
        },
            {
              qid: "FD_020_m05",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 1 (source: 3)"},
              v2: {"type": "int", "min": 500, "max": 1500, "step": 5, "description": "Value 2 (source: 1000)"},
              v3: {"type": "int", "min": 4, "max": 14, "step": 1, "description": "Value 3 (source: 9)"},
              v4: {"type": "int", "min": 2000, "max": 6000, "step": 5, "description": "Value 4 (source: 4000)"},
            },
            constraints: ["v1 != 3 or v2 != 1000 or v3 != 9"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "1000": "str(v2)", "9": "str(v3)", "4000": "str(v4)"},
              a: {"3": "str(v1)", "1000": "str(v2)", "9": "str(v3)", "4000": "str(v4)"},
            },
            sourceValues: {"v1": 3, "v2": 1000, "v3": 9, "v4": 4000},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 1 (source: 4)"},
              v2: {"type": "int", "min": 150, "max": 450, "step": 5, "description": "Value 2 (source: 300)"},
              v3: {"type": "int", "min": 3, "max": 13, "step": 1, "description": "Value 3 (source: 8)"},
              v4: {"type": "int", "min": 600, "max": 1800, "step": 5, "description": "Value 4 (source: 1200)"},
            },
            constraints: ["v1 != 4 or v2 != 300 or v3 != 8"],
            derived: {
            },
            substitutions: {
              q: {"4": "str(v1)", "300": "str(v2)", "8": "str(v3)", "1200": "str(v4)"},
              a: {"4": "str(v1)", "300": "str(v2)", "8": "str(v3)", "1200": "str(v4)"},
            },
            sourceValues: {"v1": 4, "v2": 300, "v3": 8, "v4": 1200},
          }
        },
            {
              qid: "FD_020_h02",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 1 (source: 3)"},
              v2: {"type": "int", "min": 225, "max": 675, "step": 5, "description": "Value 2 (source: 450)"},
              v3: {"type": "int", "min": 5, "max": 15, "step": 1, "description": "Value 3 (source: 10)"},
              v4: {"type": "int", "min": 90, "max": 270, "step": 5, "description": "Value 4 (source: 180)"},
            },
            constraints: ["v1 != 3 or v2 != 450 or v3 != 10"],
            derived: {
            },
            substitutions: {
              q: {"3": "str(v1)", "450": "str(v2)", "10": "str(v3)", "180": "str(v4)"},
              a: {"3": "str(v1)", "450": "str(v2)", "10": "str(v3)", "180": "str(v4)"},
            },
            sourceValues: {"v1": 3, "v2": 450, "v3": 10, "v4": 180},
          }
        },
            {
              qid: "FD_020_h03",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v3: {"type": "int", "min": 1, "max": 11, "step": 1, "description": "Value 3 (source: 6)"},
              v4: {"type": "int", "min": 1000, "max": 3000, "step": 5, "description": "Value 4 (source: 2000)"},
              v5: {"type": "int", "min": 5, "max": 15, "step": 1, "description": "Value 5 (source: 10)"},
            },
            constraints: ["v1 != 2 or v2 != 500 or v3 != 6"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "500": "str(v2)", "6": "str(v3)", "2000": "str(v4)", "10": "str(v5)"},
              a: {"2": "str(v1)", "500": "str(v2)", "6": "str(v3)", "2000": "str(v4)", "10": "str(v5)"},
            },
            sourceValues: {"v1": 2, "v2": 500, "v3": 6, "v4": 2000, "v5": 10},
          }
        },
            {
              qid: "FD_020_h04",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v4: {"type": "int", "min": 10, "max": 30, "step": 5, "description": "Value 4 (source: 20)"},
              v5: {"type": "int", "min": 5, "max": 15, "step": 1, "description": "Value 5 (source: 10)"},
            },
            constraints: ["v1 != 80 or v2 != 5 or v3 != 45"],
            derived: {
            },
            substitutions: {
              q: {"80": "str(v1)", "5": "str(v2)", "45": "str(v3)", "20": "str(v4)", "10": "str(v5)"},
              a: {"80": "str(v1)", "5": "str(v2)", "45": "str(v3)", "20": "str(v4)", "10": "str(v5)"},
            },
            sourceValues: {"v1": 80, "v2": 5, "v3": 45, "v4": 20, "v5": 10},
          }
        },
            {
              qid: "FD_020_h05",
          ...
          seedSpec: {
            ...
            parameters: {
              ...
              v2: {"type": "int", "min": 150, "max": 450, "step": 5, "description": "Value 2 (source: 300)"},
              v3: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 3 (source: 5)"},
              v4: {"type": "int", "min": 300, "max": 900, "step": 5, "description": "Value 4 (source: 600)"},
              v5: {"type": "int", "min": 2500, "max": 7500, "step": 5, "description": "Value 5 (source: 5000)"},
            },
            constraints: ["v1 != 2 or v2 != 300 or v3 != 5"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "300": "str(v2)", "5": "str(v3)", "600": "str(v4)", "5000": "str(v5)"},
              a: {"2": "str(v1)", "300": "str(v2)", "5": "str(v3)", "600": "str(v4)", "5000": "str(v5)"},
            },
            sourceValues: {"v1": 2, "v2": 300, "v3": 5, "v4": 600, "v5": 5000},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 100 or v2 != 3"],
            derived: {
            },
            substitutions: {
              q: {"100": "str(v1)", "3": "str(v2)"},
              a: {"100": "str(v1)", "3": "str(v2)"},
            },
            sourceValues: {"v1": 100, "v2": 3},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 13, "max": 37, "step": 5, "description": "Value 1 (source: 25)"},
              v2: {"type": "int", "min": 38, "max": 112, "step": 5, "description": "Value 2 (source: 75)"},
              v3: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 3 (source: 5)"},
            },
            constraints: ["v1 != 25 or v2 != 75 or v3 != 5"],
            derived: {
            },
            substitutions: {
              q: {"25": "str(v1)", "75": "str(v2)", "5": "str(v3)"},
              a: {"25": "str(v1)", "75": "str(v2)", "5": "str(v3)"},
            },
            sourceValues: {"v1": 25, "v2": 75, "v3": 5},
          }
        },
            {
              qid: "FD_021_m02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 1000 or v2 != 10"],
            derived: {
            },
            substitutions: {
              q: {"1000": "str(v1)", "10": "str(v2)"},
              a: {"1000": "str(v1)", "10": "str(v2)"},
            },
            sourceValues: {"v1": 1000, "v2": 10},
          }
        },
            {
              qid: "FD_021_m03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 5000 or v2 != 6"],
            derived: {
            },
            substitutions: {
              q: {"5000": "str(v1)", "6": "str(v2)"},
              a: {"5000": "str(v1)", "6": "str(v2)"},
            },
            sourceValues: {"v1": 5000, "v2": 6},
          }
        },
            {
              qid: "FD_021_m04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 800 or v2 != 10"],
            derived: {
            },
            substitutions: {
              q: {"800": "str(v1)", "10": "str(v2)"},
              a: {"800": "str(v1)", "10": "str(v2)"},
            },
            sourceValues: {"v1": 800, "v2": 10},
          }
        },
            {
              qid: "FD_021_m05",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 20 or v2 != 60 or v3 != -3"],
            derived: {
            },
            substitutions: {
              q: {"20": "str(v1)", "60": "str(v2)", "-3": "str(v3)"},
              a: {"20": "str(v1)", "60": "str(v2)", "-3": "str(v3)"},
            },
            sourceValues: {"v1": 20, "v2": 60, "v3": -3},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 600 or v2 != 10 or v3 != 5"],
            derived: {
            },
            substitutions: {
              q: {"600": "str(v1)", "10": "str(v2)", "5": "str(v3)"},
              a: {"600": "str(v1)", "10": "str(v2)", "5": "str(v3)"},
            },
            sourceValues: {"v1": 600, "v2": 10, "v3": 5},
          }
        },
            {
              qid: "FD_021_h03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 250 or v2 != 5"],
            derived: {
            },
            substitutions: {
              q: {"250": "str(v1)", "5": "str(v2)"},
              a: {"250": "str(v1)", "5": "str(v2)"},
            },
            sourceValues: {"v1": 250, "v2": 5},
          }
        },
            {
              qid: "FD_021_h04",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 8, "max": 22, "step": 1, "description": "Value 1 (source: 15)"},
              v2: {"type": "int", "min": 20, "max": 60, "step": 5, "description": "Value 2 (source: 40)"},
              v3: {"type": "int", "min": 15, "max": 45, "step": 5, "description": "Value 3 (source: 30)"},
              v4: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 4 (source: 2)"},
            },
            constraints: ["v1 != 15 or v2 != 40 or v3 != 30"],
            derived: {
            },
            substitutions: {
              q: {"15": "str(v1)", "40": "str(v2)", "30": "str(v3)", "2": "str(v4)"},
              a: {"15": "str(v1)", "40": "str(v2)", "30": "str(v3)", "2": "str(v4)"},
            },
            sourceValues: {"v1": 15, "v2": 40, "v3": 30, "v4": 2},
          }
        },
            {
              qid: "FD_021_h05",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 11, "max": 33, "step": 5, "description": "Value 1 (source: 22)"},
              v2: {"type": "int", "min": 29, "max": 87, "step": 5, "description": "Value 2 (source: 58)"},
              v3: {"type": "int", "min": -7, "max": 3, "step": 1, "description": "Value 3 (source: -2)"},
            },
            constraints: ["v1 != 22 or v2 != 58 or v3 != -2"],
            derived: {
            },
            substitutions: {
              q: {"22": "str(v1)", "58": "str(v2)", "-2": "str(v3)"},
              a: {"22": "str(v1)", "58": "str(v2)", "-2": "str(v3)"},
            },
            sourceValues: {"v1": 22, "v2": 58, "v3": -2},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 250, "max": 750, "step": 5, "description": "Value 1 (source: 500)"},
              v2: {"type": "int", "min": 125, "max": 375, "step": 5, "description": "Value 2 (source: 250)"},
            },
            constraints: ["v1 != 500 or v2 != 250"],
            derived: {
            },
            substitutions: {
              q: {"500": "str(v1)", "250": "str(v2)"},
              a: {"500": "str(v1)", "250": "str(v2)"},
            },
            sourceValues: {"v1": 500, "v2": 250},
          }
        },
            {
              qid: "FD_022_e02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 200 or v2 != 400"],
            derived: {
            },
            substitutions: {
              q: {"200": "str(v1)", "400": "str(v2)"},
              a: {"200": "str(v1)", "400": "str(v2)"},
            },
            sourceValues: {"v1": 200, "v2": 400},
          }
        },
            {
              qid: "FD_022_e03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 1000 or v2 != 500"],
            derived: {
            },
            substitutions: {
              q: {"1000": "str(v1)", "500": "str(v2)"},
              a: {"1000": "str(v1)", "500": "str(v2)"},
            },
            sourceValues: {"v1": 1000, "v2": 500},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 80 or v2 != 20"],
            derived: {
            },
            substitutions: {
              q: {"80": "str(v1)", "20": "str(v2)"},
              a: {"80": "str(v1)", "20": "str(v2)"},
            },
            sourceValues: {"v1": 80, "v2": 20},
          }
        },
            {
              qid: "FD_022_m02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 150 or v2 != 600"],
            derived: {
            },
            substitutions: {
              q: {"150": "str(v1)", "600": "str(v2)"},
              a: {"150": "str(v1)", "600": "str(v2)"},
            },
            sourceValues: {"v1": 150, "v2": 600},
          }
        },
            {
              qid: "FD_022_m03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 300 or v2 != 100"],
            derived: {
            },
            substitutions: {
              q: {"300": "str(v1)", "100": "str(v2)"},
              a: {"300": "str(v1)", "100": "str(v2)"},
            },
            sourceValues: {"v1": 300, "v2": 100},
          }
        },
            {
              qid: "FD_022_m04",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 1000, "max": 3000, "step": 5, "description": "Value 1 (source: 2000)"},
              v2: {"type": "int", "min": 4000, "max": 12000, "step": 5, "description": "Value 2 (source: 8000)"},
            },
            constraints: ["v1 != 2000 or v2 != 8000"],
            derived: {
            },
            substitutions: {
              q: {"2000": "str(v1)", "8000": "str(v2)"},
              a: {"2000": "str(v1)", "8000": "str(v2)"},
            },
            sourceValues: {"v1": 2000, "v2": 8000},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 10, "max": 30, "step": 5, "description": "Value 1 (source: 20)"},
              v2: {"type": "int", "min": 30, "max": 90, "step": 5, "description": "Value 2 (source: 60)"},
              v3: {"type": "int", "min": 18, "max": 52, "step": 5, "description": "Value 3 (source: 35)"},
            },
            constraints: ["v1 != 20 or v2 != 60 or v3 != 35"],
            derived: {
            },
            substitutions: {
              q: {"20": "str(v1)", "60": "str(v2)", "35": "str(v3)"},
              a: {"20": "str(v1)", "60": "str(v2)", "35": "str(v3)"},
            },
            sourceValues: {"v1": 20, "v2": 60, "v3": 35},
          }
        },
            {
              qid: "FD_022_h02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 100 or v2 != 80"],
            derived: {
            },
            substitutions: {
              q: {"100": "str(v1)", "80": "str(v2)"},
              a: {"100": "str(v1)", "80": "str(v2)"},
            },
            sourceValues: {"v1": 100, "v2": 80},
          }
        },
            {
              qid: "FD_022_h03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 400 or v2 != 300 or v3 != 200"],
            derived: {
            },
            substitutions: {
              q: {"400": "str(v1)", "300": "str(v2)", "200": "str(v3)"},
              a: {"400": "str(v1)", "300": "str(v2)", "200": "str(v3)"},
            },
            sourceValues: {"v1": 400, "v2": 300, "v3": 200},
          }
        },
            {
              qid: "FD_022_h04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 500 or v2 != 800"],
            derived: {
            },
            substitutions: {
              q: {"500": "str(v1)", "800": "str(v2)"},
              a: {"500": "str(v1)", "800": "str(v2)"},
            },
            sourceValues: {"v1": 500, "v2": 800},
          }
        },
            {
              qid: "FD_022_h05",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 600, "max": 1800, "step": 5, "description": "Value 1 (source: 1200)"},
              v2: {"type": "int", "min": 18, "max": 54, "step": 5, "description": "Value 2 (source: 36)"},
            },
            constraints: ["v1 != 1200 or v2 != 36"],
            derived: {
            },
            substitutions: {
              q: {"1200": "str(v1)", "36": "str(v2)"},
              a: {"1200": "str(v1)", "36": "str(v2)"},
            },
            sourceValues: {"v1": 1200, "v2": 36},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 8, "max": 22, "step": 1, "description": "Value 1 (source: 15)"},
              v2: {"type": "int", "min": 43, "max": 127, "step": 5, "description": "Value 2 (source: 85)"},
            },
            constraints: ["v1 != 15 or v2 != 85"],
            derived: {
            },
            substitutions: {
              q: {"15": "str(v1)", "85": "str(v2)"},
              a: {"15": "str(v1)", "85": "str(v2)"},
            },
            sourceValues: {"v1": 15, "v2": 85},
          }
        },
            {
              qid: "FD_023_e03",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 11, "max": 33, "step": 5, "description": "Value 1 (source: 22)"},
              v2: {"type": "int", "min": 24, "max": 72, "step": 5, "description": "Value 2 (source: 48)"},
            },
            constraints: ["v1 != 22 or v2 != 48"],
            derived: {
            },
            substitutions: {
              q: {"22": "str(v1)", "48": "str(v2)"},
              a: {"22": "str(v1)", "48": "str(v2)"},
            },
            sourceValues: {"v1": 22, "v2": 48},
          }
        },
            {
              qid: "FD_023_m03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 500 or v2 != 20"],
            derived: {
            },
            substitutions: {
              q: {"500": "str(v1)", "20": "str(v2)"},
              a: {"500": "str(v1)", "20": "str(v2)"},
            },
            sourceValues: {"v1": 500, "v2": 20},
          }
        },
            {
              qid: "FD_023_m05",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 25 or v2 != 30 or v3 != 15"],
            derived: {
            },
            substitutions: {
              q: {"25": "str(v1)", "30": "str(v2)", "15": "str(v3)"},
              a: {"25": "str(v1)", "30": "str(v2)", "15": "str(v3)"},
            },
            sourceValues: {"v1": 25, "v2": 30, "v3": 15},
          }
        },
            {
              qid: "FD_023_h03",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 30, "max": 90, "step": 5, "description": "Value 1 (source: 60)"},
              v2: {"type": "int", "min": 40, "max": 120, "step": 5, "description": "Value 2 (source: 80)"},
              v3: {"type": "int", "min": 45, "max": 135, "step": 5, "description": "Value 3 (source: 90)"},
            },
            constraints: ["v1 != 60 or v2 != 80 or v3 != 90"],
            derived: {
            },
            substitutions: {
              q: {"60": "str(v1)", "80": "str(v2)", "90": "str(v3)"},
              a: {"60": "str(v1)", "80": "str(v2)", "90": "str(v3)"},
            },
            sourceValues: {"v1": 60, "v2": 80, "v3": 90},
          }
        },
            {
              qid: "FD_023_h05",
...
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 300 or v2 != 5"],
            derived: {
            },
            substitutions: {
              q: {"300": "str(v1)", "5": "str(v2)"},
              a: {"300": "str(v1)", "5": "str(v2)"},
            },
            sourceValues: {"v1": 300, "v2": 5},
          }
        },
            {
              qid: "FD_024_e02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 200 or v2 != 3"],
            derived: {
            },
            substitutions: {
              q: {"200": "str(v1)", "3": "str(v2)"},
              a: {"200": "str(v1)", "3": "str(v2)"},
            },
            sourceValues: {"v1": 200, "v2": 3},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 500 or v2 != 10"],
            derived: {
            },
            substitutions: {
              q: {"500": "str(v1)", "10": "str(v2)"},
              a: {"500": "str(v1)", "10": "str(v2)"},
            },
            sourceValues: {"v1": 500, "v2": 10},
          }
        },
            {
              qid: "FD_024_m02",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 10, "max": 30, "step": 5, "description": "Value 1 (source: 20)"},
              v2: {"type": "int", "min": 35, "max": 105, "step": 5, "description": "Value 2 (source: 70)"},
              v3: {"type": "int", "min": 3, "max": 13, "step": 1, "description": "Value 3 (source: 8)"},
            },
            constraints: ["v1 != 20 or v2 != 70 or v3 != 8"],
            derived: {
            },
            substitutions: {
              q: {"20": "str(v1)", "70": "str(v2)", "8": "str(v3)"},
              a: {"20": "str(v1)", "70": "str(v2)", "8": "str(v3)"},
            },
            sourceValues: {"v1": 20, "v2": 70, "v3": 8},
          }
        },
            {
              qid: "FD_024_m03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 50 or v2 != 5"],
            derived: {
            },
            substitutions: {
              q: {"50": "str(v1)", "5": "str(v2)"},
              a: {"50": "str(v1)", "5": "str(v2)"},
            },
            sourceValues: {"v1": 50, "v2": 5},
          }
        },
            {
              qid: "FD_024_m04",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": 4.0, "max": 5.0, "step": 0.05, "description": "Value 1 (source: 4.5)"},
              v2: {"type": "int", "min": 5000, "max": 15000, "step": 5, "description": "Value 2 (source: 10000)"},
              v3: {"type": "int", "min": 8, "max": 22, "step": 1, "description": "Value 3 (source: 15)"},
            },
            constraints: ["v1 != 4.5 or v2 != 10000 or v3 != 15"],
            derived: {
            },
            substitutions: {
              q: {"4.5": "str(v1)", "10000": "str(v2)", "15": "str(v3)"},
              a: {"4.5": "str(v1)", "10000": "str(v2)", "15": "str(v3)"},
            },
            sourceValues: {"v1": 4.5, "v2": 10000, "v3": 15},
          }
        },
            {
              qid: "FD_024_m05",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 375, "max": 1125, "step": 5, "description": "Value 1 (source: 750)"},
              v2: {"type": "int", "min": 6, "max": 18, "step": 1, "description": "Value 2 (source: 12)"},
            },
            constraints: ["v1 != 750 or v2 != 12"],
            derived: {
            },
            substitutions: {
              q: {"750": "str(v1)", "12": "str(v2)"},
              a: {"750": "str(v1)", "12": "str(v2)"},
            },
            sourceValues: {"v1": 750, "v2": 12},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 13, "max": 37, "step": 5, "description": "Value 1 (source: 25)"},
              v2: {"type": "int", "min": 28, "max": 82, "step": 5, "description": "Value 2 (source: 55)"},
              v3: {"type": "int", "min": 5, "max": 15, "step": 1, "description": "Value 3 (source: 10)"},
            },
            constraints: ["v1 != 25 or v2 != 55 or v3 != 10"],
            derived: {
            },
            substitutions: {
              q: {"25": "str(v1)", "55": "str(v2)", "10": "str(v3)"},
              a: {"25": "str(v1)", "55": "str(v2)", "10": "str(v3)"},
            },
            sourceValues: {"v1": 25, "v2": 55, "v3": 10},
          }
        },
            {
              qid: "FD_024_h02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 500 or v2 != 300 or v3 != 20"],
            derived: {
            },
            substitutions: {
              q: {"500": "str(v1)", "300": "str(v2)", "20": "str(v3)"},
              a: {"500": "str(v1)", "300": "str(v2)", "20": "str(v3)"},
            },
            sourceValues: {"v1": 500, "v2": 300, "v3": 20},
          }
        },
            {
              qid: "FD_024_h03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 2000 or v2 != 4 or v3 != 5"],
            derived: {
            },
            substitutions: {
              q: {"2000": "str(v1)", "4": "str(v2)", "5": "str(v3)"},
              a: {"2000": "str(v1)", "4": "str(v2)", "5": "str(v3)"},
            },
            sourceValues: {"v1": 2000, "v2": 4, "v3": 5},
          }
        },
            {
              qid: "FD_024_h04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 800 or v2 != 5 or v3 != 10"],
            derived: {
            },
            substitutions: {
              q: {"800": "str(v1)", "5": "str(v2)", "10": "str(v3)", "20": "str(v4)"},
              a: {"800": "str(v1)", "5": "str(v2)", "10": "str(v3)", "20": "str(v4)"},
            },
            sourceValues: {"v1": 800, "v2": 5, "v3": 10, "v4": 20},
          }
        },
            {
              qid: "FD_024_h05",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 7500, "max": 22500, "step": 5, "description": "Value 1 (source: 15000)"},
              v2: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 2 (source: 3)"},
              v3: {"type": "int", "min": 2, "max": 12, "step": 1, "description": "Value 3 (source: 7)"},
            },
            constraints: ["v1 != 15000 or v2 != 3 or v3 != 7"],
            derived: {
            },
            substitutions: {
              q: {"15000": "str(v1)", "3": "str(v2)", "7": "str(v3)"},
              a: {"15000": "str(v1)", "3": "str(v2)", "7": "str(v3)"},
            },
            sourceValues: {"v1": 15000, "v2": 3, "v3": 7},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 500, "max": 1500, "step": 5, "description": "Value 1 (source: 1000)"},
              v2: {"type": "int", "min": 750, "max": 2250, "step": 5, "description": "Value 2 (source: 1500)"},
            },
            constraints: ["v1 != 1000 or v2 != 1500"],
            derived: {
            },
            substitutions: {
              q: {"1000": "str(v1)", "1500": "str(v2)"},
              a: {"1000": "str(v1)", "1500": "str(v2)"},
            },
            sourceValues: {"v1": 1000, "v2": 1500},
          }
        },
            {
              qid: "FD_025_m02",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 500, "max": 1500, "step": 5, "description": "Value 1 (source: 1000)"},
              v2: {"type": "int", "min": 1250, "max": 3750, "step": 5, "description": "Value 2 (source: 2500)"},
            },
            constraints: ["v1 != 1000 or v2 != 2500"],
            derived: {
            },
            substitutions: {
              q: {"1000": "str(v1)", "2500": "str(v2)"},
              a: {"1000": "str(v1)", "2500": "str(v2)"},
            },
            sourceValues: {"v1": 1000, "v2": 2500},
          }
        },
            {
              qid: "FD_025_m03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 22 or v2 != 58 or v3 != 50"],
            derived: {
            },
            substitutions: {
              q: {"22": "str(v1)", "58": "str(v2)", "50": "str(v3)"},
              a: {"22": "str(v1)", "58": "str(v2)", "50": "str(v3)"},
            },
            sourceValues: {"v1": 22, "v2": 58, "v3": 50},
          }
        },
            {
              qid: "FD_025_m04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 400 or v2 != 10"],
            derived: {
            },
            substitutions: {
              q: {"400": "str(v1)", "10": "str(v2)"},
              a: {"400": "str(v1)", "10": "str(v2)"},
            },
            sourceValues: {"v1": 400, "v2": 10},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 250, "max": 750, "step": 5, "description": "Value 1 (source: 500)"},
              v2: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 2 (source: 3)"},
              v3: {"type": "int", "min": 325, "max": 975, "step": 5, "description": "Value 3 (source: 650)"},
              v4: {"type": "int", "min": 500, "max": 1500, "step": 5, "description": "Value 4 (source: 1000)"},
            },
            constraints: ["v1 != 500 or v2 != 3 or v3 != 650"],
            derived: {
            },
            substitutions: {
              q: {"500": "str(v1)", "3": "str(v2)", "650": "str(v3)", "1000": "str(v4)"},
              a: {"500": "str(v1)", "3": "str(v2)", "650": "str(v3)", "1000": "str(v4)"},
            },
            sourceValues: {"v1": 500, "v2": 3, "v3": 650, "v4": 1000},
          }
        },
            {
              qid: "FD_025_h02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 800 or v2 != 400"],
            derived: {
            },
            substitutions: {
              q: {"800": "str(v1)", "400": "str(v2)"},
              a: {"800": "str(v1)", "400": "str(v2)"},
            },
            sourceValues: {"v1": 800, "v2": 400},
          }
        },
            {
              qid: "FD_025_h03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 15 or v2 != 40"],
            derived: {
            },
            substitutions: {
              q: {"15": "str(v1)", "40": "str(v2)"},
              a: {"15": "str(v1)", "40": "str(v2)"},
            },
            sourceValues: {"v1": 15, "v2": 40},
          }
        },
            {
              qid: "FD_025_h04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 20 or v2 != 40"],
            derived: {
            },
            substitutions: {
              q: {"20": "str(v1)", "40": "str(v2)"},
              a: {"20": "str(v1)", "40": "str(v2)"},
            },
            sourceValues: {"v1": 20, "v2": 40},
          }
        },
            {
              qid: "FD_025_h05",
...
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 25 or v2 != 5"],
            derived: {
            },
            substitutions: {
              q: {"25": "str(v1)", "5": "str(v2)"},
              a: {"25": "str(v1)", "5": "str(v2)"},
            },
            sourceValues: {"v1": 25, "v2": 5},
          }
        },
            {
              qid: "FD_026_m04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 1200 or v2 != 1600 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"1200": "str(v1)", "1600": "str(v2)", "4": "str(v3)"},
              a: {"1200": "str(v1)", "1600": "str(v2)", "4": "str(v3)"},
            },
            sourceValues: {"v1": 1200, "v2": 1600, "v3": 4},
          }
        },
            {
              qid: "FD_026_m05",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "int", "min": 43, "max": 127, "step": 5, "description": "Value 1 (source: 85)"},
            },
            constraints: ["v1 != 85"],
            derived: {
            },
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": -3, "max": 7, "step": 1, "description": "Value 1 (source: 2)"},
              v2: {"type": "int", "min": 375, "max": 1125, "step": 5, "description": "Value 2 (source: 750)"},
              v3: {"type": "int", "min": 0, "max": 10, "step": 1, "description": "Value 3 (source: 5)"},
              v4: {"type": "int", "min": 250, "max": 750, "step": 5, "description": "Value 4 (source: 500)"},
            },
            constraints: ["v1 != 2 or v2 != 750 or v3 != 5"],
            derived: {
            },
            substitutions: {
              q: {"2": "str(v1)", "750": "str(v2)", "5": "str(v3)", "500": "str(v4)"},
              a: {"2": "str(v1)", "750": "str(v2)", "5": "str(v3)", "500": "str(v4)"},
            },
            sourceValues: {"v1": 2, "v2": 750, "v3": 5, "v4": 500},
          }
        },
            {
              qid: "FD_026_h03",
          ...
          seedSpec: {
            ...
            reason: "Differentiation. Derivative verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": -0.57, "max": 0.43, "step": 0.05, "description": "Value 1 (source: -0.07)"},
            },
            constraints: ["v1 != -0.07"],
            derived: {
            },
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 400 or v2 != 600"],
            derived: {
            },
            substitutions: {
              q: {"400": "str(v1)", "600": "str(v2)"},
              a: {"400": "str(v1)", "600": "str(v2)"},
            },
            sourceValues: {"v1": 400, "v2": 600},
          }
        },
            {
              qid: "FD_026_h05",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 70 or v2 != 2 or v3 != 100"],
            derived: {
            },
            substitutions: {
              q: {"70": "str(v1)", "2": "str(v2)", "100": "str(v3)"},
              a: {"70": "str(v1)", "2": "str(v2)", "100": "str(v3)"},
            },
            sourceValues: {"v1": 70, "v2": 2, "v3": 100},
          }
        }
          ]
        }
,

    {
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 500 or v2 != 2"],
            derived: {
            },
            substitutions: {
              q: {"500": "str(v1)", "2": "str(v2)"},
              a: {"500": "str(v1)", "2": "str(v2)"},
            },
            sourceValues: {"v1": 500, "v2": 2},
          }
        },
            {
              qid: "FD_027_e02",
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 40, "max": 120, "step": 5, "description": "Value 1 (source: 80)"},
              v2: {"type": "int", "min": -1, "max": 9, "step": 1, "description": "Value 2 (source: 4)"},
              v3: {"type": "float", "min": -3.77, "max": -2.77, "step": 0.05, "description": "Value 3 (source: -3.27)"},
            },
            constraints: ["v1 != 80 or v2 != 4 or v3 != -3.27"],
            derived: {
            },
            substitutions: {
              q: {"80": "str(v1)", "4": "str(v2)", "-3.27": "str(v3)"},
              a: {"80": "str(v1)", "4": "str(v2)", "-3.27": "str(v3)"},
            },
            sourceValues: {"v1": 80, "v2": 4, "v3": -3.27},
          }
        }
          ],
          medium: [
          ...
          seedSpec: {
            ...
            parameters: {
              v1: {"type": "int", "min": 100, "max": 300, "step": 5, "description": "Value 1 (source: 200)"},
              v2: {"type": "int", "min": -2, "max": 8, "step": 1, "description": "Value 2 (source: 3)"},
              v3: {"type": "float", "min": -9.11, "max": -8.11, "step": 0.05, "description": "Value 3 (source: -8.61)"},
            },
            constraints: ["v1 != 200 or v2 != 3 or v3 != -8.61"],
            derived: {
            },
            substitutions: {
              q: {"200": "str(v1)", "3": "str(v2)", "-8.61": "str(v3)"},
              a: {"200": "str(v1)", "3": "str(v2)", "-8.61": "str(v3)"},
            },
            sourceValues: {"v1": 200, "v2": 3, "v3": -8.61},
          }
        },
            {
              qid: "FD_027_m02",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 22 or v2 != 58 or v3 != 5"],
            derived: {
            },
            substitutions: {
              q: {"22": "str(v1)", "58": "str(v2)", "5": "str(v3)"},
              a: {"22": "str(v1)", "58": "str(v2)", "5": "str(v3)"},
            },
            sourceValues: {"v1": 22, "v2": 58, "v3": 5},
          }
        },
            {
              qid: "FD_027_m03",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 5000 or v2 != 10"],
            derived: {
            },
            substitutions: {
              q: {"5000": "str(v1)", "10": "str(v2)"},
              a: {"5000": "str(v1)", "10": "str(v2)"},
            },
            sourceValues: {"v1": 5000, "v2": 10},
          }
        },
            {
              qid: "FD_027_m04",
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 120 or v2 != 10"],
            derived: {
            },
            substitutions: {
              q: {"120": "str(v1)", "10": "str(v2)"},
              a: {"120": "str(v1)", "10": "str(v2)"},
            },
            sourceValues: {"v1": 120, "v2": 10},
          }
        }
          ],
          hard: [
          ...
          seedSpec: {
            ...
            constraints: ["v1 != 800 or v2 != 5 or v3 != 4"],
            derived: {
            },
            substitutions: {
              q: {"800": "str(v1)", "5": "str(v2)", "4": "str(v3)", "6": "str(v4)"},
              a: {"800": "str(v1)", "5": "str(v2)", "4": "str(v3)", "6": "str(v4)"},
            },
            sourceValues: {"v1": 800, "v2": 5, "v3": 4, "v4": 6},
          }
        },
            {
              qid: "FD_027_h03",
