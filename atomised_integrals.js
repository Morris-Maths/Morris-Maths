  ...
  questions: [
...

    {
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"100": "str(v1)", "5000": "str(v2)", "10": "str(v3)"},
              a: {"100": "str(v1)", "5000": "str(v2)", "10": "str(v3)"},
            },
            sourceValues: {"v1": 100, "v2": 5000, "v3": 10},
          }
        },
          ],
          hard: [
...

    {
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"6": "str(v1)", "3": "str(v2)", "2": "str(v3)", "5": "str(v4)"},
              a: {"6": "str(v1)", "3": "str(v2)", "2": "str(v3)", "5": "str(v4)"},
            },
            sourceValues: {"v1": 6, "v2": 3, "v3": 2, "v4": 5},
          }
        },
            {
              qid: "IN_015_m02",
...

    {
          ...
          seedSpec: {
            ...
            substitutions: {
              q: {"10": "str(v1)", "4": "str(v2)", "3": "str(v3)", "2": "str(v4)"},
              a: {"10": "str(v1)", "4": "str(v2)", "3": "str(v3)", "2": "str(v4)"},
            },
            sourceValues: {"v1": 10, "v2": 4, "v3": 3, "v4": 2},
          }
        },
          ],
          hard: [
...

    {
          ...
          seedSpec: {
            ...
            reason: "Integration. Integral verified by SymPy. Numeric values parameterised. Answers must be recomputed for each variant.",
            parameters: {
              v1: {"type": "float", "min": 2.3, "max": 3.3, "step": 0.05, "description": "Value 1 (source: 2.8)"},
              v2: {"type": "float", "min": 1.7, "max": 2.7, "step": 0.05, "description": "Value 2 (source: 2.2)"},
            },
            constraints: ["v1 != 2.8 or v2 != 2.2"],
            derived: {
            },
            substitutions: {
              q: {"2.8": "str(v1)", "2.2": "str(v2)"},
              a: {"2.8": "str(v1)", "2.2": "str(v2)"},
            },
            sourceValues: {"v1": 2.8, "v2": 2.2},
          }
        },
          ],
          hard: [
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Power of x"}},
            constraints: ["a != 3"],
            derived: {"result": {"expr": "x^(a+1)/(a+1) + e^x + cos(x) + C", "note": "Anti-derivative"}},
            substitutions: {"q": {"3": "str(a)"}, "a": {"4": "str(a+1)"}},
            sourceValues: {"a": 3},
          }
        },
        {
          qid: "IN_028_e02",
          q: "Anti-differentiate $5x^4 - 2\sin x$.",
          a: "$x^5 + 2\cos x + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Basic anti-diff. Verified.",
            parameters: {"a": {"type": "int", "min": 2, "max": 8, "step": 1, "description": "Coefficient of x^4"}, "b": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Coefficient of sin"}},
            constraints: ["a != 5 or b != 2"],
            derived: {},
            substitutions: {"q": {"5": "str(a)", "2": "str(b)"}, "a": {"5": "str(a)", "2": "str(b)"}},
            sourceValues: {"a": 5, "b": 2},
          }
        },
        {
          qid: "IN_028_e03",
          ...
          seedSpec: {
            ...
            seedable: true,
            reason: "Basic anti-diff. Verified.",
            parameters: {"a": {"type": "int", "min": 2, "max": 10, "step": 2, "description": "Coefficient of x^2"}, "b": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coefficient of e^x"}},
            constraints: ["a != 6 or b != 3"],
            derived: {},
            substitutions: {"q": {"6": "str(a)", "3": "str(b)"}, "a": {"2": "str(a//3)", "6": "str(a)", "3": "str(b)"}},
            sourceValues: {"a": 6, "b": 3},
          }
        }
      ],
      medium: [
        {
          qid: "IN_028_m01",
          q: "Anti-differentiate $3x^2 + 4\cos x - 3e^x$.",
          a: "$x^3 + 4\sin x - 3e^x + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Mixed terms. Verified by SymPy.",
            parameters: {"a": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coeff of x^2"}, "b": {"type": "int", "min": 1, "max": 8, "step": 1, "description": "Coeff of cos"}, "c": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coeff of e^x"}},
            constraints: ["a != 3 or b != 4 or c != 3"],
            derived: {},
            substitutions: {"q": {"3": "str(a)", "4": "str(b)"}, "a": {"4": "str(b)", "3": "str(c)"}},
            sourceValues: {"a": 3, "b": 4, "c": 3},
          }
        },
        {
          qid: "IN_028_m02",
          q: "Anti-differentiate $\frac{1}{x^4} - 5\sin x + 6\sqrt{x}$.",
          a: "$-\frac{1}{3x^3} + 5\cos x + 4x^{3/2} + C$",
          seedSpec: {
            version: 2,
            seedable: false,
        ...
        {
          qid: "IN_028_m03",
          q: "Anti-differentiate $4x^3 - \frac{2}{x^3} + 7\cos x$.",
          a: "$x^4 + \frac{1}{x^2} + 7\sin x + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Negative powers + trig. Verified.",
            parameters: {"a": {"type": "int", "min": 2, "max": 8, "step": 2, "description": "Coeff of x^3"}, "b": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coeff of 1/x^3"}, "c": {"type": "int", "min": 2, "max": 10, "step": 1, "description": "Coeff of cos"}},
            constraints: ["a != 4 or b != 2 or c != 7"],
            derived: {},
            substitutions: {"q": {"4": "str(a)", "2": "str(b)", "7": "str(c)"}, "a": {"4": "str(a)", "7": "str(c)"}},
            sourceValues: {"a": 4, "b": 2, "c": 7},
          }
        }
      ],
      hard: [
        {
          ...
          a: "$6\sqrt{x} - 2e^x - \frac{5}{x} + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Fractional powers requiring rewrite. Verified.",
            parameters: {"a": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Numerator coeff of 1/\u221ax"}, "b": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Coeff of e^x"}, "c": {"type": "int", "min": 2, "max": 8, "step": 1, "description": "Numerator of 1/x^2"}},
            constraints: ["a != 3 or b != 2 or c != 5"],
            derived: {},
            substitutions: {"q": {"3": "str(a)", "2": "str(b)", "5": "str(c)"}, "a": {"6": "str(2*a)", "2": "str(b)", "5": "str(c)"}},
            sourceValues: {"a": 3, "b": 2, "c": 5},
          }
        },
        {
          qid: "IN_028_h02",
          q: "Anti-differentiate $8x^3 - 3\cos x + \frac{4}{x^5}$.",
          a: "$2x^4 - 3\sin x - \frac{1}{x^4} + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Mixed with high negative power. Verified.",
            parameters: {"a": {"type": "int", "min": 4, "max": 12, "step": 2, "description": "Coeff of x^3"}, "c": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coeff of cos"}},
            constraints: ["a != 8 or c != 3"],
            derived: {},
            substitutions: {"q": {"8": "str(a)", "3": "str(c)"}, "a": {"2": "str(a//4)", "3": "str(c)"}},
            sourceValues: {"a": 8, "c": 3},
          }
        },
        {
          qid: "IN_028_h03",
          q: "Anti-differentiate $2x - \frac{3}{x^2} + 4e^x - 7\sin x$.",
          a: "$x^2 + \frac{3}{x} + 4e^x + 7\cos x + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Four mixed terms. Verified.",
            parameters: {"a": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Coeff of x"}, "b": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Num of 1/x^2"}, "c": {"type": "int", "min": 1, "max": 8, "step": 1, "description": "Coeff e^x"}, "e": {"type": "int", "min": 2, "max": 10, "step": 1, "description": "Coeff sin"}},
            constraints: ["a != 2 or b != 3 or c != 4"],
            derived: {},
            substitutions: {"q": {"2": "str(a)", "3": "str(b)", "4": "str(c)", "7": "str(e)"}, "a": {"3": "str(b)", "4": "str(c)", "7": "str(e)"}},
            sourceValues: {"a": 2, "b": 3, "c": 4, "e": 7},
          }
        }
      ],
    },
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"b": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Constant in (x+b)^2"}},
            constraints: ["b != 3"],
            derived: {"b2": {"expr": "b**2", "note": "Constant term after expansion"}},
            substitutions: {"q": {"3": "str(b)"}, "a": {"6": "str(2*b)", "9": "str(b2)", "3": "str(b)"}},
            sourceValues: {"b": 3},
          }
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Coeff of x"}, "b": {"type": "int", "min": -4, "max": 4, "step": 1, "description": "Constant"}},
            constraints: ["a != 2 or b != -1"],
            derived: {},
            substitutions: {"q": {"2": "str(a)", "1": "str(abs(b))"}, "a": {"4": "str(a**2)"}},
            sourceValues: {"a": 2, "b": -1},
          }
        },
        {
          qid: "IN_029_e03",
          ...
          seedSpec: {
            ...
            parameters: {"b": {"type": "int", "min": 1, "max": 8, "step": 1, "description": "Constant in x(x+b)"}},
            constraints: ["b != 4"],
            derived: {},
            substitutions: {"q": {"4": "str(b)"}, "a": {"4": "str(b)", "2": "str(b//2)"}},
            sourceValues: {"b": 4},
          }
        }
      ],
      medium: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Coeff of x^2 in bracket"}, "b": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Constant in bracket"}},
            constraints: ["a != 3 or b != 2"],
            derived: {},
            substitutions: {"q": {"3": "str(a)", "2": "str(b)"}, "a": {"9": "str(a**2)", "12": "str(2*a*b)", "4": "str(b**2)"}},
            sourceValues: {"a": 3, "b": 2},
          }
        },
        {
          qid: "IN_029_m02",
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coeff of x in bracket"}, "b": {"type": "int", "min": 1, "max": 8, "step": 1, "description": "Constant in bracket"}},
            constraints: ["a != 3 or b != 5"],
            derived: {},
            substitutions: {"q": {"3": "str(a)", "5": "str(b)"}, "a": {"3": "str(a)", "5": "str(b)"}},
            sourceValues: {"a": 3, "b": 5},
          }
        },
        {
          qid: "IN_029_m03",
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": -3, "max": 3, "step": 1, "description": "First constant"}, "b": {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Second constant"}},
            constraints: ["a != 1 or b != -3"],
            derived: {},
            substitutions: {"q": {"1": "str(a)", "3": "str(abs(b))"}, "a": {}},
            sourceValues: {"a": 1, "b": -3},
          }
        }
      ],
      hard: [
        ...
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"b": {"type": "int", "min": 1, "max": 8, "step": 1, "description": "Constant subtracted from x"}},
            constraints: ["b != 4"],
            derived: {},
            substitutions: {"q": {"4": "str(b)"}, "a": {"4": "str(b)", "8": "str(2*b)"}},
            sourceValues: {"b": 4},
          }
        },
        {
          ...
          a: "$= \int (1 + \frac{4}{x} + \frac{4}{x^2}) \, dx = x + 4\ln|x| - \frac{4}{x} + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Expand fraction. Verified.",
            parameters: {"a": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Constant in numerator (x+a)^2"}},
            constraints: ["a != 2"],
            derived: {},
            substitutions: {"q": {"2": "str(a)"}, "a": {"4": "str(a**2)"}},
            sourceValues: {"a": 2},
          }
        }
      ],
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Coeff of x"}, "b": {"type": "int", "min": -3, "max": 5, "step": 1, "description": "Constant"}, "n": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Power"}},
            constraints: ["a != 2 or b != 1 or n != 3"],
            derived: {"denom": {"expr": "a*(n+1)", "note": "Denominator = a \u00d7 (n+1)"}},
            substitutions: {"q": {"2": "str(a)", "1": "str(b)", "3": "str(n)"}, "a": {"8": "str(denom)", "4": "str(n+1)"}},
            sourceValues: {"a": 2, "b": 1, "n": 3},
          }
        },
        {
          qid: "IN_030_e02",
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Coeff of x"}, "b": {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant"}, "n": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Power"}},
            constraints: ["a != 3 or b != -2 or n != 4"],
            derived: {"denom": {"expr": "a*(n+1)", "note": "Denominator"}},
            substitutions: {"q": {"3": "str(a)", "2": "str(abs(b))", "4": "str(n)"}, "a": {"15": "str(denom)", "5": "str(n+1)"}},
            sourceValues: {"a": 3, "b": -2, "n": 4},
          }
        },
        {
          qid: "IN_030_e03",
          ...
          seedSpec: {
            ...
            parameters: {"k": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Outer coefficient"}, "b": {"type": "int", "min": 1, "max": 8, "step": 1, "description": "Constant"}, "n": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Power"}},
            constraints: ["k != 4 or b != 5 or n != 3"],
            derived: {},
            substitutions: {"q": {"4": "str(k)", "5": "str(b)", "3": "str(n)"}, "a": {"5": "str(b)"}},
            sourceValues: {"k": 4, "b": 5, "n": 3},
          }
        }
      ],
      medium: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Coeff of x (= outer coeff)"}, "b": {"type": "int", "min": -5, "max": 5, "step": 1, "description": "Constant"}, "n": {"type": "int", "min": 3, "max": 6, "step": 1, "description": "Power"}},
            constraints: ["a != 3 or b != -1 or n != 4"],
            derived: {"result_denom": {"expr": "n+1", "note": "Just n+1 since outer coeff = inner derivative"}},
            substitutions: {"q": {"3": "str(a)", "1": "str(abs(b))", "4": "str(n)"}, "a": {"5": "str(result_denom)"}},
            sourceValues: {"a": 3, "b": -1, "n": 4},
          }
        },
        {
          qid: "IN_030_m02",
          ...
          seedSpec: {
            ...
            parameters: {"k": {"type": "int", "min": 6, "max": 20, "step": 2, "description": "Numerator"}, "a": {"type": "int", "min": 2, "max": 8, "step": 1, "description": "Coeff of x"}, "b": {"type": "int", "min": -6, "max": 6, "step": 1, "description": "Constant"}},
            constraints: ["k != 14 or a != 7 or b != -3"],
            derived: {},
            substitutions: {"q": {"14": "str(k)", "7": "str(a)", "3": "str(abs(b))"}, "a": {"2": "str(k//a)", "7": "str(a)", "3": "str(abs(b))"}},
            sourceValues: {"k": 14, "a": 7, "b": -3},
          }
        },
        {
          qid: "IN_030_m03",
          ...
          seedSpec: {
            ...
            parameters: {"k": {"type": "int", "min": 2, "max": 10, "step": 2, "description": "Outer coeff"}, "a": {"type": "int", "min": -4, "max": -1, "step": 1, "description": "Coeff of x (negative)"}, "b": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Constant"}, "n": {"type": "int", "min": 3, "max": 7, "step": 1, "description": "Power"}},
            constraints: ["k != 6 or a != -2 or n != 5"],
            derived: {},
            substitutions: {"q": {"6": "str(k)", "2": "str(abs(a))", "1": "str(b)", "5": "str(n)"}, "a": {}},
            sourceValues: {"k": 6, "a": -2, "b": 1, "n": 5},
          }
        }
      ],
      hard: [
        {
          ...
          a: "$= \int 5(3x+4)^{-1/2} \, dx = \frac{5}{3} \cdot 2(3x+4)^{1/2} + C = \frac{10\sqrt{3x+4}}{3} + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Fractional power linear composite. Verified.",
            parameters: {"k": {"type": "int", "min": 2, "max": 8, "step": 1, "description": "Numerator"}, "a": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Coeff of x"}, "b": {"type": "int", "min": 1, "max": 8, "step": 1, "description": "Constant"}},
            constraints: ["k != 5 or a != 3 or b != 4"],
            derived: {},
            substitutions: {"q": {"5": "str(k)", "3": "str(a)", "4": "str(b)"}, "a": {"10": "str(2*k)", "3": "str(a)"}},
            sourceValues: {"k": 5, "a": 3, "b": 4},
          }
        },
        {
          qid: "IN_030_h02",
          ...
          seedSpec: {
            ...
            parameters: {"k": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Numerator"}, "a": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Coeff of x"}, "n": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Denominator power"}},
            constraints: ["k != 3 or a != 2 or n != 4"],
            derived: {},
            substitutions: {"q": {"3": "str(k)", "2": "str(a)", "4": "str(n)"}, "a": {}},
            sourceValues: {"k": 3, "a": 2, "n": 4},
          }
        },
        {
          qid: "IN_030_h03",
          ...
          seedSpec: {
            ...
            parameters: {"k": {"type": "int", "min": -12, "max": -2, "step": 2, "description": "Outer coeff (negative)"}, "a": {"type": "int", "min": -6, "max": -1, "step": 1, "description": "Coeff of x"}, "b": {"type": "int", "min": 1, "max": 8, "step": 1, "description": "Constant"}, "n": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Power"}},
            constraints: ["k != -8 or a != -4 or n != 3"],
            derived: {},
            substitutions: {"q": {"8": "str(abs(k))", "4": "str(abs(a))", "5": "str(b)", "3": "str(n)"}, "a": {}},
            sourceValues: {"k": -8, "a": -4, "b": 5, "n": 3},
          }
        }
      ],
    },
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 2, "max": 8, "step": 1, "description": "Coefficient of x in exponent"}},
            constraints: ["a != 4"],
            derived: {},
            substitutions: {"q": {"4": "str(a)"}, "a": {"4": "str(a)"}},
            sourceValues: {"a": 4},
          }
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"k": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Outer coefficient"}, "a": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Coeff of x"}},
            constraints: ["k != 3 or a != 2"],
            derived: {},
            substitutions: {"q": {"3": "str(k)", "2": "str(a)"}, "a": {"3": "str(k)", "2": "str(a)"}},
            sourceValues: {"k": 3, "a": 2},
          }
        },
        {
          qid: "IN_031_e03",
      ...
      medium: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"k": {"type": "int", "min": 2, "max": 10, "step": 2, "description": "Outer coeff"}, "a": {"type": "int", "min": -6, "max": -1, "step": 1, "description": "Coeff of x (negative)"}},
            constraints: ["k != 6 or a != -3"],
            derived: {},
            substitutions: {"q": {"6": "str(k)", "3": "str(abs(a))"}, "a": {"2": "str(abs(k//a))", "3": "str(abs(a))"}},
            sourceValues: {"k": 6, "a": -3},
          }
        },
        {
          qid: "IN_031_m02",
          ...
          seedSpec: {
            ...
            parameters: {"k": {"type": "int", "min": 2, "max": 8, "step": 2, "description": "Outer coeff"}, "a": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Coeff of x"}, "b": {"type": "int", "min": -8, "max": -1, "step": 1, "description": "Constant in exponent"}},
            constraints: ["k != 4 or a != 2 or b != -5"],
            derived: {},
            substitutions: {"q": {"4": "str(k)", "2": "str(a)", "5": "str(abs(b))"}, "a": {"2": "str(k//a)"}},
            sourceValues: {"k": 4, "a": 2, "b": -5},
          }
        },
        {
          qid: "IN_031_m03",
          ...
          seedSpec: {
            ...
            parameters: {"k": {"type": "int", "min": -8, "max": -2, "step": 1, "description": "Outer coeff"}, "a": {"type": "float", "min": 0.2, "max": 0.8, "step": 0.1, "description": "Coeff of x (decimal)"}},
            constraints: ["k != -5 or a != 0.5"],
            derived: {},
            substitutions: {"q": {"5": "str(abs(k))", "0.5": "str(a)"}, "a": {"10": "str(abs(round(k/a)))"}},
            sourceValues: {"k": -5, "a": 0.5},
          }
        }
      ],
      hard: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coeff of e^2x"}, "b": {"type": "int", "min": 1, "max": 8, "step": 1, "description": "Coeff of e^-x"}, "c": {"type": "int", "min": 1, "max": 8, "step": 1, "description": "Constant term"}},
            constraints: ["a != 3 or b != 4 or c != 5"],
            derived: {},
            substitutions: {"q": {"3": "str(a)", "4": "str(b)", "5": "str(c)"}, "a": {"4": "str(b)", "5": "str(c)"}},
            sourceValues: {"a": 3, "b": 4, "c": 5},
          }
        },
        {
          qid: "IN_031_h02",
          ...
          seedSpec: {
            ...
            parameters: {"k": {"type": "int", "min": 2, "max": 12, "step": 2, "description": "Numerator"}, "a": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Exponent coefficient"}},
            constraints: ["k != 8 or a != 4"],
            derived: {},
            substitutions: {"q": {"8": "str(k)", "4": "str(a)"}, "a": {"2": "str(k//a)", "4": "str(a)"}},
            sourceValues: {"k": 8, "a": 4},
          }
        },
        {
          qid: "IN_031_h03",
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Coeff of first exp"}, "b": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "First inner coeff"}, "c": {"type": "int", "min": 2, "max": 8, "step": 2, "description": "Numerator of second"}},
            constraints: ["a != 2 or b != 3 or c != 6"],
            derived: {},
            substitutions: {"q": {"2": "str(a)", "3": "str(b)", "6": "str(c)"}, "a": {"2": "str(a)", "3": "str(b)"}},
            sourceValues: {"a": 2, "b": 3, "c": 6},
          }
        }
      ],
    },

    {
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Coefficient of x"}},
            constraints: ["a != 2"],
            derived: {},
            substitutions: {"q": {"2": "str(a)"}, "a": {"2": "str(a)"}},
            sourceValues: {"a": 2},
          }
        },
        {
          ...
          seedSpec: {
            ...
            constraints: ["a != 3"],
            derived: {},
            substitutions: {"q": {"3": "str(a)"}, "a": {"3": "str(a)"}},
            sourceValues: {"a": 3},
          }
        },
        {
          qid: "IN_032_e03",
          q: "Find $\int 4\cos 2x \, dx$.",
          a: "$= 2\sin 2x + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "k·cos(ax). Verified.",
            parameters: {"k": {"type": "int", "min": 2, "max": 8, "step": 1, "description": "Outer coefficient"}, "a": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Coeff of x"}},
            constraints: ["k != 4 or a != 2"],
            derived: {},
            substitutions: {"q": {"4": "str(k)", "2": "str(a)"}, "a": {"2": "str(k//a)"}},
            sourceValues: {"k": 4, "a": 2},
          }
        }
      ],
      medium: [
        {
          qid: "IN_032_m01",
          q: "Find $\int -6\sin 3x \, dx$.",
          a: "$= \frac{-6}{3}(-\cos 3x) = 2\cos 3x + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Negative coeff with sin. Verified.",
            parameters: {"k": {"type": "int", "min": -10, "max": -2, "step": 2, "description": "Outer coeff"}, "a": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Inner coeff"}},
            constraints: ["k != -6 or a != 3"],
            derived: {},
            substitutions: {"q": {"6": "str(abs(k))", "3": "str(a)"}, "a": {"2": "str(abs(k)//a)", "3": "str(a)"}},
            sourceValues: {"k": -6, "a": 3},
          }
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Coeff of x"}, "b": {"type": "int", "min": -6, "max": 6, "step": 1, "description": "Constant"}},
            constraints: ["a != 4 or b != -3"],
            derived: {},
            substitutions: {"q": {"4": "str(a)", "3": "str(abs(b))"}, "a": {"4": "str(a)"}},
            sourceValues: {"a": 4, "b": -3},
          }
        },
        {
          qid: "IN_032_m03",
          q: "Find $\int (3\cos 2x - 5\sin x) \, dx$.",
          a: "$= \frac{3}{2}\sin 2x + 5\cos x + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Mixed trig. Verified.",
            parameters: {"a": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coeff of cos"}, "b": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Inner coeff of cos"}, "c": {"type": "int", "min": 1, "max": 8, "step": 1, "description": "Coeff of sin"}},
            constraints: ["a != 3 or b != 2 or c != 5"],
            derived: {},
            substitutions: {"q": {"3": "str(a)", "2": "str(b)", "5": "str(c)"}, "a": {"5": "str(c)"}},
            sourceValues: {"a": 3, "b": 2, "c": 5},
          }
        }
      ],
      hard: [
        {
          qid: "IN_032_h01",
          q: "Find $\int (2\sin(3x+1) - 4\cos(2x-5) + e^x) \, dx$.",
          a: "$= -\frac{2}{3}\cos(3x+1) - 2\sin(2x-5) + e^x + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Mixed trig + exp. Verified.",
            parameters: {"a": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Coeff sin"}, "b": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Inner sin"}, "c": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coeff cos"}, "e": {"type": "int", "min": 2, "max": 4, "step": 1, "description": "Inner cos"}},
            constraints: ["a != 2 or b != 3 or c != 4"],
            derived: {},
            substitutions: {"q": {"2": "str(a)", "3": "str(b)", "4": "str(c)"}, "a": {}},
            sourceValues: {"a": 2, "b": 3, "c": 4, "e": 2},
          }
        },
        {
          qid: "IN_032_h02",
          q: "Find $\int \frac{6\sin 2x}{\cos^2 2x} \, dx$.",
          a: "Not linear composite — this is $6\sec 2x \tan 2x$, but rewrite as $-6 \cdot (-\sin 2x) \cdot (\cos 2x)^{-2}$. RCR with $g = \cos 2x$: $= \frac{3}{\cos 2x} + C = 3\sec 2x + C$",
          seedSpec: {
            version: 2,
            seedable: false,
        ...
        {
          qid: "IN_032_h03",
          q: "Find $\int (\sin^2 x + \cos^2 x + 3\sin 4x) \, dx$.",
          a: "$\sin^2 x + \cos^2 x = 1$. So $= \int (1 + 3\sin 4x) \, dx = x - \frac{3}{4}\cos 4x + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Identity simplification + linear composite. Verified.",
            parameters: {"k": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coeff of sin"}, "a": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Inner coeff of sin"}},
            constraints: ["k != 3 or a != 4"],
            derived: {},
            substitutions: {"q": {"3": "str(k)", "4": "str(a)"}, "a": {"3": "str(k)", "4": "str(a)"}},
            sourceValues: {"k": 3, "a": 4},
          }
        }
      ],
    },
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Coeff of x"}, "b": {"type": "int", "min": 0, "max": 4, "step": 1, "description": "Constant"}, "lo": {"type": "int", "min": 0, "max": 2, "step": 1, "description": "Lower bound"}, "hi": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Upper bound"}},
            constraints: ["hi > lo", "a != 2 or b != 1 or hi != 3"],
            derived: {"result": {"expr": "a*hi**2/2 + b*hi - a*lo**2/2 - b*lo", "note": "F(hi) - F(lo)"}},
            substitutions: {"q": {"2": "str(a)", "1": "str(b)", "0": "str(lo)", "3": "str(hi)"}, "a": {"12": "str(result)"}},
            sourceValues: {"a": 2, "b": 1, "lo": 0, "hi": 3},
          }
        },
        {
          qid: "IN_038_e02",
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coefficient"}, "lo": {"type": "int", "min": 0, "max": 2, "step": 1, "description": "Lower"}, "hi": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Upper"}},
            constraints: ["hi > lo", "a != 3 or lo != 1 or hi != 2"],
            derived: {"result": {"expr": "a*(hi**3 - lo**3)/3", "note": "Definite integral"}},
            substitutions: {"q": {"3": "str(a)", "1": "str(lo)", "2": "str(hi)"}, "a": {"7": "str(result)"}},
            sourceValues: {"a": 3, "lo": 1, "hi": 2},
          }
        },
        {
          qid: "IN_038_e03",
          ...
          seedSpec: {
            ...
            parameters: {"b": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Coeff of x (negative)"}, "hi": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Upper bound"}},
            constraints: ["b != 2 or hi != 4"],
            derived: {},
            substitutions: {"q": {"2": "str(b)", "4": "str(hi)"}, "a": {"16": "str(hi**3//3)"}},
            sourceValues: {"b": 2, "hi": 4},
          }
        }
      ],
      medium: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Coeff of x^2"}, "b": {"type": "int", "min": -3, "max": 3, "step": 1, "description": "Constant"}, "lo": {"type": "int", "min": -3, "max": 0, "step": 1, "description": "Lower"}, "hi": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Upper"}},
            constraints: ["hi > lo", "a != 3 or b != -1 or lo != -1 or hi != 2"],
            derived: {},
            substitutions: {"q": {"3": "str(a)", "1": "str(abs(b))"}, "a": {}},
            sourceValues: {"a": 3, "b": -1, "lo": -1, "hi": 2},
          }
        },
        {
          qid: "IN_038_m02",
          q: "Evaluate $\int_0^4 \left(\frac{1}{2\sqrt{x}} - 2x\right) \, dx$.",
          a: "$= [\sqrt{x} - x^2]_0^4 = (2 - 16) - 0 = -14$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Surd term definite. Verified.",
            parameters: {"hi": {"type": "int", "min": 1, "max": 9, "step": 1, "description": "Upper bound (perfect square)"}},
            constraints: ["hi != 4"],
            derived: {},
            substitutions: {"q": {"4": "str(hi)"}, "a": {}},
            sourceValues: {"hi": 4},
          }
        },
        {
          qid: "IN_038_m03",
          q: "Evaluate $\int_1^4 (3\sqrt{x} - \frac{2}{x^2}) \, dx$.",
          a: "$= [2x^{3/2} + \frac{2}{x}]_1^4 = (16 + \frac{1}{2}) - (2 + 2) = \frac{25}{2}$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Mixed powers. Verified.",
            parameters: {"a": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coeff of \u221ax"}, "b": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Numerator of 1/x^2"}},
            constraints: ["a != 3 or b != 2"],
            derived: {},
            substitutions: {"q": {"3": "str(a)", "2": "str(b)"}, "a": {}},
            sourceValues: {"a": 3, "b": 2},
          }
        }
      ],
      hard: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"b": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Coeff of x (middle term)"}, "c": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Constant"}, "lo": {"type": "int", "min": -3, "max": -1, "step": 1, "description": "Lower"}, "hi": {"type": "int", "min": 1, "max": 3, "step": 1, "description": "Upper"}},
            constraints: ["hi > lo", "b != 4 or c != 3 or lo != -2"],
            derived: {},
            substitutions: {"q": {"4": "str(b)", "3": "str(c)"}, "a": {}},
            sourceValues: {"b": 4, "c": 3, "lo": -2, "hi": 1},
          }
        },
        {
          qid: "IN_038_h02",
          q: "Evaluate $\int_1^9 \frac{x+1}{\sqrt{x}} \, dx$.",
          a: "$= \int_1^9 (x^{1/2} + x^{-1/2}) \, dx = [\frac{2x^{3/2}}{3} + 2\sqrt{x}]_1^9 = (18 + 6) - (\frac{2}{3} + 2) = \frac{64}{3}$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Rewrite fraction then integrate. Verified.",
            parameters: {"hi": {"type": "int", "min": 4, "max": 16, "step": 1, "description": "Upper (perfect square)"}},
            constraints: ["hi != 9"],
            derived: {},
            substitutions: {"q": {"9": "str(hi)"}, "a": {}},
            sourceValues: {"hi": 9},
          }
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"c": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Constant term"}, "hi": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Upper bound"}},
            constraints: ["c != 3 or hi != 2"],
            derived: {},
            substitutions: {"q": {"3": "str(c)", "2": "str(hi)"}, "a": {}},
            sourceValues: {"c": 3, "hi": 2},
          }
        }
      ],
    },
      ...
      easy: [
        {
          ...
          a: "$= [-\cos x]_0^{\pi} = (-\cos\pi) - (-\cos 0) = 1 + 1 = 2$",
          seedSpec: {
            version: 2,
            seedable: false,
        ...
        {
          qid: "IN_039_e03",
          q: "Evaluate $\int_0^{\pi/2} 3\cos x \, dx$.",
          a: "$= [3\sin x]_0^{\pi/2} = 3(1) - 3(0) = 3$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Scaled trig definite. Verified.",
            parameters: {"k": {"type": "int", "min": 1, "max": 8, "step": 1, "description": "Coefficient"}},
            constraints: ["k != 3"],
            derived: {},
            substitutions: {"q": {"3": "str(k)"}, "a": {"3": "str(k)"}},
            sourceValues: {"k": 3},
          }
        }
      ],
      medium: [
        {
          ...
          a: "$= [\frac{1}{3}\sin 3x]_{-\pi}^{\pi/2} = \frac{1}{3}(\sin\frac{3\pi}{2} - \sin(-3\pi)) = \frac{1}{3}(-1 - 0) = -\frac{1}{3}$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "cos(ax) with exact bounds. Verified.",
            parameters: {"a": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Inner coefficient"}},
            constraints: ["a != 3"],
            derived: {},
            substitutions: {"q": {"3": "str(a)"}, "a": {"3": "str(a)"}},
            sourceValues: {"a": 3},
        ...
        {
          qid: "IN_039_m02",
          q: "Evaluate $\int_0^{\pi/4} 2\sin 2x \, dx$.",
          a: "$= [-\cos 2x]_0^{\pi/4} = -\cos(\pi/2) + \cos 0 = 0 + 1 = 1$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "sin(2x) with π/4 bound. Verified.",
            parameters: {"k": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Outer coefficient"}, "a": {"type": "int", "min": 2, "max": 4, "step": 1, "description": "Inner coefficient"}},
            constraints: ["k != 2 or a != 2"],
            derived: {},
            substitutions: {"q": {"2": "str(k)"}, "a": {"2": "str(k)"}},
            sourceValues: {"k": 2, "a": 2},
          }
        },
        {
          qid: "IN_039_m03",
          q: "Evaluate $\int_{\pi/6}^{\pi/2} 4\cos x \, dx$.",
          a: "$= [4\sin x]_{\pi/6}^{\pi/2} = 4(1) - 4(\frac{1}{2}) = 4 - 2 = 2$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "cos with π/6 lower bound. Verified.",
            parameters: {"k": {"type": "int", "min": 2, "max": 8, "step": 2, "description": "Coefficient"}},
            constraints: ["k != 4"],
            derived: {},
            substitutions: {"q": {"4": "str(k)"}, "a": {"4": "str(k)", "2": "str(k//2)"}},
            sourceValues: {"k": 4},
          }
        }
      ],
      hard: [
        {
          ...
          a: "$g(x) = \cos x$, $g'(x) = -\sin x$. $= -\frac{1}{3}[\cos^3 x]_{\pi/6}^{\pi} = -\frac{1}{3}((-1)^3 - (\frac{\sqrt{3}}{2})^3) = -\frac{1}{3}(-1 - \frac{3\sqrt{3}}{8}) = \frac{1}{3} + \frac{\sqrt{3}}{8}$",
          seedSpec: {
            version: 2,
            seedable: false,
        ...
        {
          qid: "IN_039_h03",
          q: "Evaluate $\int_0^{\pi} (2\cos x - \sin 2x) \, dx$.",
          a: "$= [2\sin x + \frac{1}{2}\cos 2x]_0^{\pi} = (0 + \frac{1}{2}) - (0 + \frac{1}{2}) = 0$",
          seedSpec: {
            version: 2,
            seedable: false,
      ...
      easy: [
        ...
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Coefficient inside exponent"}},
            constraints: ["a != 2"],
            derived: {},
            substitutions: {"q": {"2": "str(a)", "6": "str(3*a)"}, "a": {"2": "str(a)"}},
            sourceValues: {"a": 2},
          }
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Coeff of x^2"}, "b": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Constant in exponent"}},
            constraints: ["a != 2 or b != 1"],
            derived: {},
            substitutions: {"q": {"2": "str(a)", "1": "str(b)", "4": "str(2*a)"}, "a": {"2": "str(a)", "1": "str(b)"}},
            sourceValues: {"a": 2, "b": 1},
          }
        }
      ],
      medium: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"k": {"type": "int", "min": 2, "max": 10, "step": 2, "description": "Outer coeff"}, "a": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Coeff of x^3 in exponent"}},
            constraints: ["k != 6 or a != 4"],
            derived: {"adj": {"expr": "round(k/(3*a),4)", "note": "Adjustment factor k/(3a)"}},
            substitutions: {"q": {"6": "str(k)", "4": "str(a)"}, "a": {"4": "str(a)"}},
            sourceValues: {"k": 6, "a": 4},
          }
        },
        {
          qid: "IN_033_m02",
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": -5, "max": -1, "step": 1, "description": "Coeff of x^2 (negative)"}},
            constraints: ["a != -3"],
            derived: {},
            substitutions: {"q": {"3": "str(abs(a))"}, "a": {"6": "str(abs(2*a))", "3": "str(abs(a))"}},
            sourceValues: {"a": -3},
          }
        },
        {
      ...
      hard: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Multiplier of g'(x)"}},
            constraints: ["a != 2"],
            derived: {},
            substitutions: {"q": {"4": "str(2*a)", "2": "str(a)"}, "a": {"2": "str(a)"}},
            sourceValues: {"a": 2},
          }
        },
        {
          qid: "IN_033_h02",
          q: "Find $\int \frac{e^{\sqrt{x}}}{2\sqrt{x}} \, dx$.",
          a: "$g(x) = \sqrt{x}$, $g'(x) = \frac{1}{2\sqrt{x}}$ (present). $= e^{\sqrt{x}} + C$",
          seedSpec: {
            version: 2,
            seedable: false,
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"n": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Power of sin"}},
            constraints: ["n != 3"],
            derived: {},
            substitutions: {"q": {"3": "str(n)"}, "a": {"4": "str(n+1)"}},
            sourceValues: {"n": 3},
          }
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"n": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Power of cos"}},
            constraints: ["n != 2"],
            derived: {},
            substitutions: {"q": {"2": "str(n)"}, "a": {"3": "str(n+1)"}},
            sourceValues: {"n": 2},
          }
        },
        {
          qid: "IN_035_e03",
          q: "Find $\int 4\cos x \sin x \, dx$.",
          a: "$g(x) = \sin x$, $g'(x) = \cos x$. $= 4 \cdot \frac{\sin^2 x}{2} = 2\sin^2 x + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            ...
            constraints: ["k != 4"],
            derived: {},
            substitutions: {"q": {"4": "str(k)"}, "a": {"2": "str(k//2)"}},
            sourceValues: {"k": 4},
          }
        }
      ],
      medium: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"n": {"type": "int", "min": 3, "max": 7, "step": 1, "description": "Power"}},
            constraints: ["n != 4"],
            derived: {},
            substitutions: {"q": {"4": "str(n)"}, "a": {"5": "str(n+1)"}},
            sourceValues: {"n": 4},
          }
        },
        {
          ...
          a: "$g(x) = \cos 4x$, $g'(x) = -4\sin 4x$. $= -\frac{\cos^4 4x}{16} + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Composite argument. Verified.",
            parameters: {"a": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Argument coefficient"}, "n": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Power of cos"}},
            constraints: ["a != 4 or n != 3"],
            derived: {},
            substitutions: {"q": {"4": "str(a)", "3": "str(n)"}, "a": {"4": "str(a)", "16": "str(a*(n+1))"}},
            sourceValues: {"a": 4, "n": 3},
          }
        },
        {
          qid: "IN_035_m03",
          q: "Find $\int 6\cos 2x \sin^2 2x \, dx$.",
          a: "$g(x) = \sin 2x$, $g'(x) = 2\cos 2x$. $= \frac{6}{2} \cdot \frac{\sin^3 2x}{3} = \sin^3 2x + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Adjustment factor with composite. Verified.",
            parameters: {"k": {"type": "int", "min": 2, "max": 10, "step": 2, "description": "Outer coefficient"}, "a": {"type": "int", "min": 2, "max": 4, "step": 1, "description": "Inner coefficient"}, "n": {"type": "int", "min": 2, "max": 4, "step": 1, "description": "Power"}},
            constraints: ["k != 6 or a != 2 or n != 2"],
            derived: {},
            substitutions: {"q": {"6": "str(k)", "2": "str(a)"}, "a": {}},
            sourceValues: {"k": 6, "a": 2, "n": 2},
          }
        }
      ],
      hard: [
        {
          ...
          a: "$= \int \sin x \cdot (\cos x)^{-3} \, dx$. $g = \cos x$, $g' = -\sin x$. $= \frac{(\cos x)^{-2}}{2} = \frac{1}{2\cos^2 x} + C = \frac{1}{2}\sec^2 x + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Trig quotient as negative power RCR. Verified.",
            parameters: {"n": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Power of cos in denominator"}},
            constraints: ["n != 3"],
            derived: {},
            substitutions: {"q": {"3": "str(n)"}, "a": {}},
            sourceValues: {"n": 3},
          }
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"n": {"type": "int", "min": 3, "max": 8, "step": 1, "description": "Power of cos"}},
            constraints: ["n != 5"],
            derived: {},
            substitutions: {"q": {"5": "str(n)"}, "a": {"6": "str(n+1)"}},
            sourceValues: {"n": 5},
          }
        },
        {
          qid: "IN_035_h03",
          q: "Find $\int \frac{3\cos x}{\sin^4 x} \, dx$.",
          a: "$g = \sin x$, $g' = \cos x$. $= 3 \cdot \frac{(\sin x)^{-3}}{-3} = -\frac{1}{\sin^3 x} + C$",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Quotient with RCR. Verified.",
            parameters: {"k": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Numerator coefficient"}, "n": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Power in denominator"}},
            constraints: ["k != 3 or n != 4"],
            derived: {},
            substitutions: {"q": {"3": "str(k)", "4": "str(n)"}, "a": {}},
            sourceValues: {"k": 3, "n": 4},
          }
        }
      ],
    },
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Coeff of t in integrand"}, "b": {"type": "int", "min": 0, "max": 4, "step": 1, "description": "Constant in integrand"}},
            constraints: ["a != 3 or b != 1"],
            derived: {},
            substitutions: {"q": {"3": "str(a)", "1": "str(b)"}, "a": {"3": "str(a)", "1": "str(b)", "6": "str(2*a)"}},
            sourceValues: {"a": 3, "b": 1},
          }
        },
        {
          qid: "IN_041_e02",
        ...
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Coefficient of x in upper limit"}, "n": {"type": "int", "min": 2, "max": 4, "step": 1, "description": "Power in integrand"}},
            constraints: ["a != 2 or n != 2"],
            derived: {},
            substitutions: {"q": {"2": "str(a)"}, "a": {"8": "str(a**(n+1))"}},
            sourceValues: {"a": 2, "n": 2},
          }
        }
      ],
      medium: [
        ...
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Coeff inside tan"}, "b": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Coeff in exponent"}},
            constraints: ["a != 4 or b != 3"],
            derived: {},
            substitutions: {"q": {"4": "str(a)", "3": "str(b)"}, "a": {"4": "str(a)", "3": "str(b)"}},
            sourceValues: {"a": 4, "b": 3},
          }
        },
        {
      ...
      hard: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Coefficient of t"}},
            constraints: ["a != 3"],
            derived: {},
            substitutions: {"q": {"3": "str(a)"}, "a": {"6": "str(2*a)", "3": "str(a)"}},
            sourceValues: {"a": 3},
          }
        },
        {
        ...
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Coefficient of x in lower limit"}},
            constraints: ["a != 2"],
            derived: {},
            substitutions: {"q": {"2": "str(a)"}, "a": {"2": "str(a)", "4": "str(a**2)"}},
            sourceValues: {"a": 2},
          }
        }
      ],
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"c": {"type": "int", "min": 1, "max": 9, "step": 1, "description": "Constant (so y=x^2-c, crosses at \u221ac)"}, "hi": {"type": "int", "min": 3, "max": 5, "step": 1, "description": "Upper bound"}},
            constraints: ["c != 4 or hi != 3"],
            derived: {},
            substitutions: {"q": {"4": "str(c)", "3": "str(hi)"}, "a": {"4": "str(c)", "2": "str(int(c**0.5))", "3": "str(hi)"}},
            sourceValues: {"c": 4, "hi": 3},
          }
        },
        {
          qid: "IN_042_e02",
          ...
          seedSpec: {
            ...
            seedable: true,
            reason: "Factored quadratic. Verified.",
            parameters: {"a": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Root (y=x(x-a))"}, "hi": {"type": "int", "min": 3, "max": 6, "step": 1, "description": "Upper bound"}},
            constraints: ["a != 2 or hi != 3", "hi > a"],
            derived: {},
            substitutions: {"q": {"2": "str(a)", "3": "str(hi)"}, "a": {"2": "str(a)", "3": "str(hi)"}},
            sourceValues: {"a": 2, "hi": 3},
          }
        },
        {
          qid: "IN_042_e03",
      ...
      medium: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"b": {"type": "int", "min": 1, "max": 9, "step": 1, "description": "Coefficient (y = x^3 - bx)"}},
            constraints: ["b != 4"],
            derived: {},
            substitutions: {"q": {"4": "str(b)"}, "a": {"4": "str(b)", "2": "str(int(b**0.5))"}},
            sourceValues: {"b": 4},
          }
        },
        {
          qid: "IN_042_m02",
          q: "Find the area between $y = \sin x$ and the $x$-axis from $x = 0$ to $x = 2\pi$.",
          a: "$\sin x \geq 0$ on $[0,\pi]$, $\leq 0$ on $[\pi,2\pi]$. Area $= \int_0^{\pi} \sin x \,dx + |\int_{\pi}^{2\pi} \sin x \,dx| = 2 + 2 = 4$",
          seedSpec: {
            version: 2,
            seedable: false,
        ...
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Coeff of x^2"}, "b": {"type": "int", "min": 2, "max": 8, "step": 2, "description": "Coeff of x"}},
            constraints: ["a != 2 or b != 6"],
            derived: {},
            substitutions: {"q": {"2": "str(a)", "6": "str(b)"}, "a": {"3": "str(b//(2*a))", "2": "str(a)", "6": "str(b)"}},
            sourceValues: {"a": 2, "b": 6},
          }
        }
      ],
      hard: [
        ...
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"c": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Constant (y = e^x - c)"}},
            constraints: ["c != 3"],
            derived: {},
            substitutions: {"q": {"3": "str(c)"}, "a": {"3": "str(c)"}},
            sourceValues: {"c": 3},
          }
        },
        {
          qid: "IN_042_h03",
          q: "Find the area between $y = \cos x$ and the $x$-axis from $x = 0$ to $x = \frac{3\pi}{2}$.",
          a: "$\cos x \geq 0$ on $[0,\pi/2]$, $\leq 0$ on $[\pi/2, 3\pi/2]$. Area $= 1 + 2 = 3$",
          seedSpec: {
            version: 2,
            seedable: false,
...

    {
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"c": {"type": "int", "min": 1, "max": 9, "step": 1, "description": "Constant (y = c)"}, "hi": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Upper x-bound"}},
            constraints: ["c != 4 or hi != 2"],
            derived: {},
            substitutions: {"q": {"4": "str(c)", "2": "str(hi)"}, "a": {"4": "str(c)", "2": "str(hi)"}},
            sourceValues: {"c": 4, "hi": 2},
          }
        },
        {
          qid: "IN_044_e02",
        ...
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "Slope"}, "b": {"type": "int", "min": 0, "max": 5, "step": 1, "description": "y-intercept"}, "lo": {"type": "int", "min": 0, "max": 3, "step": 1, "description": "Lower"}, "hi": {"type": "int", "min": 3, "max": 6, "step": 1, "description": "Upper"}},
            constraints: ["a != 3 or b != 2 or lo != 1 or hi != 4"],
            derived: {},
            substitutions: {"q": {"3": "str(a)", "2": "str(b)", "1": "str(lo)", "4": "str(hi)"}, "a": {"3": "str(a)", "2": "str(b)", "1": "str(lo)", "4": "str(hi)"}},
            sourceValues: {"a": 3, "b": 2, "lo": 1, "hi": 4},
          }
        }
      ],
      medium: [
        ...
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"c": {"type": "int", "min": 1, "max": 9, "step": 1, "description": "Constant (y=x^2-c)"}},
            constraints: ["c != 4"],
            derived: {},
            substitutions: {"q": {"4": "str(c)"}, "a": {"4": "str(c)", "2": "str(int(c**0.5))"}},
            sourceValues: {"c": 4},
          }
        }
      ],
      hard: [
        ...
        },
        {
          ...
          a: "Total area $= \frac{1}{2}\pi(2)^2 + \frac{1}{2}(3)(4) = 2\pi + 6$. (Signed integral would be $2\pi - 6$.)",
          seedSpec: {
            version: 2,
            seedable: true,
            reason: "Geometric area from description. Verified.",
            parameters: {"r": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Semicircle radius"}, "b": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Triangle base"}, "h": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Triangle height"}},
            constraints: ["r != 2 or b != 3 or h != 4"],
            derived: {"area": {"expr": "round(0.5*3.14159*r**2 + 0.5*b*h, 2)", "note": "Total area"}},
            substitutions: {"q": {"2": "str(r)", "3": "str(b)", "4": "str(h)"}, "a": {"2": "str(r)", "3": "str(b)", "4": "str(h)"}},
            sourceValues: {"r": 2, "b": 3, "h": 4},
          }
        }
      ],
    },
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"c": {"type": "int", "min": 1, "max": 9, "step": 1, "description": "y-value (y = c, x-bound = \u221ac)"}},
            constraints: ["c != 4"],
            derived: {"xb": {"expr": "round(c**0.5, 4)", "note": "x-bound = \u221ac"}},
            substitutions: {"q": {"4": "str(c)"}, "a": {"4": "str(c)", "2": "str(int(c**0.5))"}},
            sourceValues: {"c": 4},
          }
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 2, "max": 8, "step": 2, "description": "Coefficient of x^3"}},
            constraints: ["a != 4"],
            derived: {},
            substitutions: {"q": {"4": "str(a)"}, "a": {"4": "str(a)"}},
            sourceValues: {"a": 4},
        ...
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"c": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "y-value"}},
            constraints: ["c != 3"],
            derived: {"xb": {"expr": "c**2", "note": "x-bound = c^2"}},
            substitutions: {"q": {"3": "str(c)"}, "a": {"9": "str(c**2)", "3": "str(c)"}},
            sourceValues: {"c": 3},
          }
        }
      ],
      medium: [
        {
          ...
          a: "$y = e^x \Rightarrow x = \ln y$. Area $= \int_1^{e^2} \ln y \, dy = [y\ln y - y]_1^{e^2} = (2e^2 - e^2) - (0 - 1) = e^2 + 1$.\nAlternatively: rectangle $2 \times e^2$ minus $\int_0^2 e^x \, dx = 2e^2 - (e^2-1) = e^2 + 1$",
          seedSpec: {
            version: 2,
            seedable: false,
        ...
        },
        {
          ...
          seedSpec: {
            ...
            seedable: true,
            reason: "Cubic complement. Verified.",
            parameters: {"c": {"type": "int", "min": 1, "max": 27, "step": 1, "description": "y-value (must be perfect cube)"}, "hi": {"type": "int", "min": 1, "max": 3, "step": 1, "description": "x-bound (cube root of c)"}},
            constraints: ["c != 8 or hi != 2"],
            derived: {},
            substitutions: {"q": {"8": "str(c)", "2": "str(hi)"}, "a": {"16": "str(c*hi)", "8": "str(c)", "2": "str(hi)"}},
            sourceValues: {"c": 8, "hi": 2},
          }
        },
        {
          qid: "IN_043_m03",
      ...
      hard: [
        ...
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"n": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Power"}, "c": {"type": "int", "min": 8, "max": 32, "step": 8, "description": "y-value"}},
            constraints: ["n != 4 or c != 16"],
            derived: {},
            substitutions: {"q": {"4": "str(n)", "16": "str(c)"}, "a": {"16": "str(c)"}},
            sourceValues: {"n": 4, "c": 16},
          }
        },
        {
          qid: "IN_043_h03",
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 3, "step": 1, "description": "Coefficient in exponent"}},
            constraints: ["a != 2"],
            derived: {},
            substitutions: {"q": {"2": "str(a)"}, "a": {"2": "str(a)", "4": "str(2*a)"}},
            sourceValues: {"a": 2},
          }
        }
      ],
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"tp": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Turning point x-value"}, "hi": {"type": "int", "min": 2, "max": 6, "step": 1, "description": "Upper integral bound"}, "val": {"type": "int", "min": 8, "max": 24, "step": 4, "description": "Integral value"}},
            constraints: ["tp != 2 or hi != 4 or val != 16"],
            derived: {},
            substitutions: {"q": {"2": "str(tp)", "4": "str(hi)", "16": "str(val)"}, "a": {"2": "str(tp)", "4": "str(hi)", "16": "str(val)"}},
            sourceValues: {"tp": 2, "hi": 4, "val": 16},
          }
        }
      ],
      medium: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"tp": {"type": "int", "min": 1, "max": 5, "step": 1, "description": "Turning point"}, "hi": {"type": "int", "min": 4, "max": 8, "step": 2, "description": "Upper bound"}, "c": {"type": "int", "min": 0, "max": 3, "step": 1, "description": "Constant term"}, "val": {"type": "int", "min": 12, "max": 36, "step": 6, "description": "Integral value"}},
            constraints: ["tp != 3 or hi != 6 or val != 24"],
            derived: {},
            substitutions: {"q": {"3": "str(tp)", "6": "str(hi)", "1": "str(c)", "24": "str(val)"}, "a": {"3": "str(tp)", "6": "str(hi)", "24": "str(val)"}},
            sourceValues: {"tp": 3, "hi": 6, "c": 1, "val": 24},
          }
        }
      ],
      hard: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"ip": {"type": "int", "min": 1, "max": 3, "step": 1, "description": "Inflection point x"}, "hi": {"type": "int", "min": 2, "max": 5, "step": 1, "description": "Upper bound"}, "val": {"type": "int", "min": 6, "max": 18, "step": 3, "description": "Integral value"}},
            constraints: ["ip != 1 or hi != 3 or val != 9"],
            derived: {},
            substitutions: {"q": {"1": "str(ip)", "3": "str(hi)", "9": "str(val)"}, "a": {}},
            sourceValues: {"ip": 1, "hi": 3, "val": 9},
          }
        }
      ],
    },
      ...
      easy: [
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 3, "step": 1, "description": "Coefficient of x^2"}, "c": {"type": "int", "min": 0, "max": 4, "step": 1, "description": "Constant"}},
            constraints: ["a != 1 or c != 1"],
            derived: {},
            substitutions: {"q": {"1": "str(c)"}, "a": {}},
            sourceValues: {"a": 1, "c": 1},
          }
        },
        {
          qid: "IN_037_e02",
        ...
        },
        {
          ...
          seedSpec: {
            ...
            parameters: {"a": {"type": "int", "min": 1, "max": 4, "step": 1, "description": "Slope"}, "b": {"type": "int", "min": 1, "max": 6, "step": 1, "description": "y-intercept"}},
            constraints: ["a != 2 or b != 3"],
            derived: {},
            substitutions: {"q": {"2": "str(a)", "3": "str(b)"}, "a": {"3": "str(b)"}},
            sourceValues: {"a": 2, "b": 3},
          }
        }
      ],
      medium: [
